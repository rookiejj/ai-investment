...
로컬 세션·리모트 트리거 동일 원칙. **Claude Opus 4.6** 고정 (`claude-opus-4-6`). Sonnet으로 실행 중이면 즉시 `/model opus`.
...
- 구성: **8 카테고리 × 정확히 7 ETF = 56 ETF** (Top7 일관성)
...
- 구성: **6 카테고리 × 정확히 7 기업 = 42 기업** (Top7 일관성)
