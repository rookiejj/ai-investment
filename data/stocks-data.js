...
const data = [
  {
    ...
    tag: "모델·엔터프라이즈 SW",
    stocks: [
      { tk:"MSFT", nm:"Microsoft", rs:"4/23 사상 첫 자발적 바이아웃 발표·美 인력 7% 약 8,750명 대상·연령+근속 70 충족자·4/29 장후 Q1 컨센 EPS $4.05 매출 $81.4B Azure +37%", r1:"282", p1:"101", r2:"325", p2:"118" },
      ...
      { tk:"META", nm:"Meta", rs:"4/23 인력 10% 약 8,000명 정리 5/20 시행 발표·CapEx $115~135B 가이던스 유지·Superintelligence Labs 베팅 가속·4/29 장후 Q1 컨센 EPS $6.65 매출 $55.5B", r1:"201", p1:"66", r2:"235", p2:"72" },
  ...
  },
  {
    ...
    tag: "AI칩·파운드리·장비·메모리",
    stocks: [
      { tk:"NVDA", nm:"NVIDIA", rs:"4/27 종가 $216.57 +4.0% 사상 최고 갱신·시총 $5.3T·QCOM·OpenAI·MediaTek 2028 AI 스마트폰 칩 협력 보도로 온디바이스 AI TAM 확대·반도체 섹터 동반 강세·5/20 Q1 FY27 컨센 $78B·Rubin 풀프로덕션", r1:"216", p1:"117", r2:"337", p2:"192" },
  ...
  },
  {
    ...
    tag: "석유메이저·LNG·유전서비스",
    stocks: [
      { tk:"XOM", nm:"ExxonMobil", rs:"4/27 트럼프 안보팀 회의서 이란 호르무즈 재개방 제안 검토·핵협상 후순위 양보안엔 회의적·휴전 추가 연장·Brent $107·WTI $95대 박스권·정유 마진 확장 분기 추가 연장 가정", r1:"332", p1:"29", r2:"345", p2:"32" },
      { tk:"CVX", nm:"Chevron", rs:"4/27 백악관 'Trump가 이란 제안 검토 중·수용 가능성 낮다'고 평가·이란 외무 Araghchi 푸틴 면담 다자 외교 가속·WTI $95대·호르무즈 통항 정상화 2H 26 가정 후퇴", r1:"189", p1:"12", r2:"195", p2:"14" },
      { tk:"LNG", nm:"Cheniere", rs:"미 최대 LNG 수출·호르무즈 봉쇄 두 달째 장기화·유럽 프리미엄 $19/MMBtu 강세 유지·이란 신제안 트럼프 거부 시 아시아 재라우팅 수혜 한 분기 추가 연장", r1:"16", p1:"3.5", r2:"18", p2:"4.2" },
      ...
      { tk:"COP", nm:"ConocoPhillips", rs:"상류 E&P·4/27 트럼프 이란 안 거부 톤 우세·휴전만 연장·핵 양보 없는 봉쇄 해제는 레버리지 상실 우려·Brent $107·WTI $95대 박스 상단·E&P CapEx 가속 가능성", r1:"60", p1:"10", r2:"64", p2:"11" },
  ...
  },
  {
    ...
    stocks: [
      ...
      { tk:"GM", nm:"General Motors", rs:"4/28 장전 Q1 실적·고마진 트럭·SUV 전략 vs 유가 강세 부담 점검·EV 전환 가속", r1:"185", p1:"10", r2:"190", p2:"11" },
  ...
  },
  {
    ...
    stocks: [
      ...
      { tk:"MSTR", nm:"Strategy", rs:"BTC 4/27 $80K 저항 8일 연속 무산·매물대 상단 집중·현물 ETF 누적 유입 $21억 강세 유지·총 815,061 BTC 평단 $74,395 평가익 보존·USD-DXY -0.91 4년 최강 음의 상관", r1:"0.5", p1:"-0.2", r2:"0.55", p2:"-0.15" },
  ...
  },
  {
    ...
    stocks: [
      ...
      { tk:"SBUX", nm:"Starbucks", rs:"4/28 장후 Q2 컨센 매출 $9.3B +5.4%·EPS $0.43·Niccol 턴어라운드 1년차 동일점포·중국 마진 회복 핵심 점검", r1:"36", p1:"3.5", r2:"38", p2:"4.0" },
    ]
  },
];