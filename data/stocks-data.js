...
const data = [
  {
    ...
    stocks: [
      ...
      { tk:"PLTR", nm:"Palantir", rs:"5/4 장후 Q1 매출 $1.633B +85% YoY 컨센 $1.54B 압도·조정 EPS $0.33 vs $0.28 상회·미국 매출 +104%·미 상업 $595M +133%·미 정부 +84%·순익 $870M 4배·Q2 가이던스 $1.8B vs $1.68B·FY26 매출 $7.65~7.66B +71%·FCF $4.2~4.4B 상향·Rule of 40 = 145%", r1:"7.7", p1:"1.5", r2:"10", p2:"2.4" },
  ...
  },
  {
    ...
    stocks: [
      ...
      { tk:"AMD", nm:"AMD", rs:"5/5 장후 Q1 D-Day·컨센 매출 $9.84B +32% YoY·EPS $1.27·DC 매출 $5.56B +39%·자체 가이던스 $9.9B±$300M·GM 약 55% 가이던스로 -2pt 압박·MI450 하반기 캐파 + OpenAI 6GW(1차 1GW 2H) + Meta 6GW Helios 진척 단일 분기점·Lisa Su 'MI450 고객 anxious' 발언 정량화 시험대", r1:"26", p1:"3.5", r2:"34", p2:"5.5" },
    ]
  },
  {
    title: "🏢 데이터센터",
  ...
  },
  {
    ...
    stocks: [
      ...
      { tk:"MSTR", nm:"Strategy", rs:"5/5 장후 Q1 D-Day(KST 5/6 06:00)·세일러 13주 연속 BTC 매수 사이클 첫 중단 후 결과 발표·BTC 5/5 $79K 박스권 5/4 $80,617 3개월 고점에서 후퇴·818,334 BTC 평단 $75,537 평가익 약 $3.5B·옵션 ±8% 변동성·컨센 매출 $125M +12.5% YoY·EPS -$15.87·1M BTC 목표 가이던스 재확인 여부 핵심", r1:"0.5", p1:"-0.2", r2:"0.55", p2:"-0.15" },
