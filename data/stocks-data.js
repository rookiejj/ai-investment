...
const data = [
  {
    ...
    tag: "모델·엔터프라이즈 SW",
    stocks: [
      { tk:"MSFT", nm:"Microsoft", rs:"4/29 美장후 4사 동시 실적 발표 80초 윈도우 진입·컨센 EPS $4.05 매출 $81.4B·Azure +37% 가이던스·OpenAI 매출 미스 보도 후 AI CapEx 회수율 검증대·YTD -12% 메가캡 중 약세", r1:"282", p1:"101", r2:"325", p2:"118" },
      { tk:"GOOGL", nm:"Alphabet", rs:"4/29 美장후 Q1 실적 컨센 매출 $92.2B +20.6%·EPS $2.64·GCP 폭증 가속 점검대·Anthropic $40B 투자 후 Gemini 채택·TPU 매출 신뢰 점검·1개월 +28%", r1:"403", p1:"132", r2:"455", p2:"148" },
      { tk:"META", nm:"Meta", rs:"4/29 美장후 Q1 컨센 EPS $6.65 매출 $55.5B·광고 +30% 가속 시 2026 광고 매출 GOOGL 추월 잠재·CapEx $115~135B 검증·1개월 +29% 가격 두꺼움 가이던스 미달 시 변동성 확대", r1:"201", p1:"66", r2:"235", p2:"72" },
  ...
  },
  {
    ...
    tag: "AI칩·파운드리·장비·메모리",
    stocks: [
      { tk:"NVDA", nm:"NVIDIA", rs:"4/28 OpenAI 매출 미스 WSJ 보도로 시총 $5.33T 유지하며 $210.23로 7거래일 만의 첫 조정·전일 $216.61 사상 최고 후 -2.9%·5/20 Q1 FY27 컨센 $78B·Rubin 풀프로덕션", r1:"216", p1:"117", r2:"337", p2:"192" },
      { tk:"AVGO", nm:"Broadcom", rs:"4/28 OpenAI 매출 미스 보도로 -4% 동조 하락·OpenAI 자체 ASIC 협력 펀딩 의구심·커스텀 ASIC AI 백로그 $73B 견조", r1:"64", p1:"23", r2:"88", p2:"34" },
  ...
  },
  {
    ...
    tag: "석유메이저·LNG·유전서비스",
    stocks: [
      { tk:"XOM", nm:"ExxonMobil", rs:"4/29 Brent $113.47 8거래일 연속 갭업 2022년 6월 이후 최고·WTI $99 $100선 재공방·미·이란 협상 정체로 호르무즈 봉쇄 두 달째·정유 마진 확장 분기 추가 보존·5/2 Q1 실적 컨센 EPS $1.74", r1:"332", p1:"29", r2:"345", p2:"32" },
      { tk:"CVX", nm:"Chevron", rs:"4/29 WTI $99 8거래일째 강세·트럼프 행정부 이란 봉쇄 해제 제안 거부 톤 우세·핵 양보 없는 봉쇄 해제 레버리지 상실 우려 강화·5/2 Q1 실적 컨센 EPS $2.41 점검대", r1:"189", p1:"12", r2:"195", p2:"14" },
      { tk:"LNG", nm:"Cheniere", rs:"미 최대 LNG 수출·호르무즈 봉쇄 두 달째 장기화·Brent $113 8거래일 강세로 유럽 프리미엄 $19/MMBtu 추가 강세·이란 신제안 거부 톤 우세·아시아 재라우팅 수혜 분기 추가 보존", r1:"16", p1:"3.5", r2:"18", p2:"4.2" },
      ...
      { tk:"COP", nm:"ConocoPhillips", rs:"상류 E&P·4/29 Brent $113·WTI $99 박스 상단 추가 돌파·트럼프 휴전만 연장·핵 양보 없는 봉쇄 해제 거부 톤·E&P CapEx 가속 시그널·셰일 마진 확장", r1:"60", p1:"10", r2:"64", p2:"11" },
  ...
  },
  {
    ...
    tag: "방어+성장 혼합",
    stocks: [
      { tk:"AMZN", nm:"Amazon", rs:"4/29 美장후 Q1 실적 발표·AWS 매출 가속·CapEx $200B 가이던스 회수율 점검대·1개월 +31% 메가캡 중 가장 강한 가격·Trainium 채택·이커머스 견조", r1:"717", p1:"78", r2:"800", p2:"95" },
      ...
      { tk:"SBUX", nm:"Starbucks", rs:"4/28 장후 Q2 EPS $0.50 컨센 $0.42 비트·글로벌 동일점포 +6.2% 컨센 +4% 상회·미국 +7.1% 트래픽 2분기 연속 양전환·FY26 SSS 가이던스 5%로 상향(기존 3%)·EPS $2.25~2.45", r1:"36", p1:"3.5", r2:"38", p2:"4.0" },
    ]
  },
];