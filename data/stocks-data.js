...
const data = [
  ...
  },
  {
    ...
    stocks: [
      ...
      { tk:"AMD", nm:"AMD", rs:"5/5 장후 Q1 매출 $10.3B +38% YoY 컨센 $9.84B 큰 폭 상회·EPS $1.37 vs $1.25 +9.6% 상회·DC 매출 $5.8B +57% YoY 가속·Q2 가이던스 $11.2B vs 컨센 $10.52B 큰 폭 상회·Lisa Su 'DC가 매출·이익 성장 1차 동인'·시간외 +5% ATH $379.90 도달", r1:"26", p1:"3.5", r2:"34", p2:"5.5" },
    ]
  },
  {
    title: "🏢 데이터센터",
