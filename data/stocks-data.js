...
const data = [
  ...
  },
  {
    ...
    tag: "AI칩·파운드리·장비·메모리",
    stocks: [
      { tk:"NVDA", nm:"NVIDIA", rs:"4/24 종가 $208.27 사상 최고 시총 $5.12T·다만 YTD +7%로 MU +69%·AMD +43%·TSM +26% 대비 부진 섹터 로테이션 진행·5/20 Q1 FY27 컨센 $78B·Rubin 풀프로덕션", r1:"216", p1:"117", r2:"337", p2:"192" },
  ...
  },
  {
    ...
    tag: "석유메이저·LNG·유전서비스",
    stocks: [
      { tk:"XOM", nm:"ExxonMobil", rs:"4/27 이란이 호르무즈 재개방+종전 신제안·핵협상은 후순위 분리·트럼프 월요일 Situation Room 안보팀 소집·Brent $105.7 5거래일 연속 상승 주간 +17%", r1:"332", p1:"29", r2:"345", p2:"32" },
      { tk:"CVX", nm:"Chevron", rs:"4/27 이란 신제안 백악관 접수·WH '협상 언론 노출 안 해' 신중 톤·핵 양보 분리 시 트럼프 레버리지 축소 우려·WTI $94.40·호르무즈 두 달째 봉쇄", r1:"189", p1:"12", r2:"195", p2:"14" },
      { tk:"LNG", nm:"Cheniere", rs:"미 최대 LNG 수출·호르무즈 봉쇄 장기화 유럽 프리미엄 $19/MMBtu 지속·이란 신제안 해제 시점 불확실 아시아 재라우팅 수혜 연장", r1:"16", p1:"3.5", r2:"18", p2:"4.2" },
      ...
      { tk:"COP", nm:"ConocoPhillips", rs:"상류 E&P·이란 호르무즈 재개방 신제안 트럼프 검토 단계·핵 분리 시나리오 부각·Brent +17% WTI +14% 주간 누적 마진 확대 구간 연장", r1:"60", p1:"10", r2:"64", p2:"11" },
  ...
  },
  {
    ...
    stocks: [
      ...
      { tk:"MSTR", nm:"Strategy", rs:"4/27 이란 호르무즈 재개방 신제안에 BTC $78K 상단 시도·일요 야간 선물 변동성·총 815,061 BTC 평단 $74,395 평가익 유지·달러 인덱스와 4년 최강 음의 상관 지속", r1:"0.5", p1:"-0.2", r2:"0.55", p2:"-0.15" },
