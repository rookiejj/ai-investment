...
const data = [
  ...
  },
  {
    ...
    tag: "석유메이저·LNG·유전서비스",
    stocks: [
      { tk:"XOM", nm:"ExxonMobil", rs:"4/28 Brent $110·WTI $98 7거래일 연속 갭업·미·이란 협상 정체로 호르무즈 통항 봉쇄 장기화·정유 마진 확장 분기 추가 연장·5/2 Q1 실적 컨센 EPS $1.74", r1:"332", p1:"29", r2:"345", p2:"32" },
      { tk:"CVX", nm:"Chevron", rs:"4/28 WTI $98 +2.4% 7거래일 연속 상승·테헤란 파키스탄 통한 봉쇄해제 조건부 시그널·미국 회의적 톤 유지·5/2 Q1 실적 컨센 EPS $2.41 점검대", r1:"189", p1:"12", r2:"195", p2:"14" },
      ...
      { tk:"COP", nm:"ConocoPhillips", rs:"상류 E&P·4/28 Brent $110·WTI $98 박스 상단 갱신·휴전만 연장·핵 양보 없는 봉쇄 해제 레버리지 상실 우려·E&P CapEx 가속 시그널", r1:"60", p1:"10", r2:"64", p2:"11" },
