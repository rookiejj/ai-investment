...
const data = [
  ...
  },
  {
    ...
    tag: "석유메이저·LNG·유전서비스",
    stocks: [
      { tk:"XOM", nm:"ExxonMobil", rs:"4/29 Brent $118.03 +6% 9거래일 연속 갭업 2022년 6월 이후 최고·WTI $106.88 +7% 정착·트럼프 '봉쇄가 폭격보다 효과적' 발언으로 핵합의 전 봉쇄 유지 톤 굳어짐·정유 마진 분기 추가 확장·5/2 Q1 컨센 EPS $1.74", r1:"332", p1:"29", r2:"345", p2:"32" },
      { tk:"CVX", nm:"Chevron", rs:"4/29 WTI $106.88 +7% 신고가·Trump '돼지 멱따이듯 짓눌렸다' 발언으로 봉쇄 해제 거부 강화·핵합의 없는 호르무즈 통항 정상화 2H26 너머로 후퇴·5/2 Q1 컨센 EPS $2.41", r1:"189", p1:"12", r2:"195", p2:"14" },
      { tk:"LNG", nm:"Cheniere", rs:"미 최대 LNG 수출·호르무즈 봉쇄 두 달째 장기화·4/29 Brent $118 +6% 신고가로 유럽·아시아 프리미엄 추가 확장·트럼프 봉쇄 유지 발언·재라우팅 수혜 분기 보존", r1:"16", p1:"3.5", r2:"18", p2:"4.2" },
      ...
      { tk:"COP", nm:"ConocoPhillips", rs:"상류 E&P·4/29 WTI $106.88·Brent $118 박스 상단 신고가·트럼프 봉쇄 무기한 유지 발언·핵 양보 없는 통항 정상화 거부·E&P CapEx 가속 시그널·셰일 마진 추가 확장", r1:"60", p1:"10", r2:"64", p2:"11" },
  ...
  },
  {
    ...
    stocks: [
      ...
      { tk:"MSTR", nm:"Strategy", rs:"4/29 FOMC 3.50~3.75% 동결 8-4 표결 1992년 이후 최대 의견대립·Powell 잔류 시사·BTC $77,200 횡보·총 818,334 BTC 평단 $75,537 평가익 잔존·BTC Yield YTD 9.6%·세일러 1M BTC 목표 진척", r1:"0.5", p1:"-0.2", r2:"0.55", p2:"-0.15" },
