...
const data = [
  ...
  },
  {
    ...
    tag: "석유메이저·LNG·유전서비스",
    stocks: [
      { tk:"XOM", nm:"ExxonMobil", rs:"Brent $95대 유지·4/22 美-이란 휴전 만료·평화협상 불확실성·호르무즈 통항 급감 지속", r1:"332", p1:"29", r2:"345", p2:"32" },
      { tk:"CVX", nm:"Chevron", rs:"WTI $89~90·Brent $95~96·4/22 휴전 만료 임박·트럼프 휴전 연장 거부 시그널·S&P 4/21 -0.63% 리스크오프", r1:"189", p1:"12", r2:"195", p2:"14" },
      { tk:"LNG", nm:"Cheniere", rs:"미 최대 LNG 수출·호르무즈 장기 폐쇄 시 유럽 LNG 프리미엄 지속·아시아 재라우팅", r1:"16", p1:"3.5", r2:"18", p2:"4.2" },
  ...
  },
  {
    ...
    stocks: [
      ...
      { tk:"MSTR", nm:"Strategy", rs:"BTC $76K 회복·4/21 +2.7% 휴전 협상 진전·Warsh 인사청문회 앞둬·78만 9천 BTC 평균단가 $75,577 위 공방", r1:"0.5", p1:"-0.2", r2:"0.55", p2:"-0.15" },
