...
const data = [
  {
    ...
    tag: "모델·엔터프라이즈 SW",
    stocks: [
      { tk:"MSFT", nm:"Microsoft", rs:"4/29 장후 Q1 FY26 매출 $77.7B +18% EPS $4.13 컨센 상회·Azure $21.5B +38% CC 용량 한계로 +40% 잠재·OpenAI 지분 손실 -$0.41 EPS·FY26 CapEx 증가율 FY25 초과 가속 가이던스·GAAP $3.72 +13%", r1:"282", p1:"101", r2:"325", p2:"118" },
      { tk:"GOOGL", nm:"Alphabet", rs:"4/29 장후 Q1 매출 $109.9B +22% 컨센 $107.1B 상회·EPS $5.11 vs 컨센 $2.62 압도·Cloud $20.03B +63% 백로그 $460B QoQ 두 배·CapEx $180~190B 상향·Pichai '컴퓨트 제약' 직접 언급", r1:"403", p1:"132", r2:"455", p2:"148" },
      { tk:"META", nm:"Meta", rs:"4/29 장후 Q1 매출 $56.31B +33% 컨센 $55.45B 상회·EPS $10.44(세제혜택 $8B 포함, 조정 $7.31)·영업이익률 41%·CapEx $125~145B 상향($115~135B에서)·Q2 $58~61B·DAP 3.56B 컨센 3.62B 하회·AH -6%", r1:"201", p1:"66", r2:"235", p2:"72" },
      { tk:"ORCL", nm:"Oracle", rs:"4/28 OpenAI 매출 컨센 하회 WSJ 보도로 -4% 급락·$300B 5년 컴퓨트 공급 계약 펀딩 우려 부각·Oracle '기술 채택 가속·신규 5.5 모델 모멘텀' 적극 방어·RPO $553B", r1:"57", p1:"12", r2:"68", p2:"15" },
      { tk:"PLTR", nm:"Palantir", rs:"5/5 장중 -6.59% 폭락 - Q1 매출 +85%·FY26 +71% 가이던스 상향에도 P/S 67·P/E 150 밸류 부담·경쟁 우위 정점 우려 부각·옵션 ±10% 변동성 가격 하방 연출·미 상업 +133% 정량 입증분 흡수 후 차익실현·11분기 연속 매출 가속 모멘텀은 유지", r1:"7.7", p1:"1.5", r2:"10", p2:"2.4" },
  ...
  },
  {
    ...
    tag: "AI칩·파운드리·장비·메모리",
    stocks: [
      { tk:"NVDA", nm:"NVIDIA", rs:"4/29 GOOGL Cloud +63% 백로그 $460B·MSFT Azure +38% 용량 한계·META CapEx $125~145B 상향·AMZN AWS +28% 컨센 상회로 메가캡 4사 일제 AI 인프라 가속 재확인·OpenAI 매출 컨센 하회 우려 부분 상쇄·5/20 Q1 FY27 컨센 $78B·Rubin 풀프로덕션", r1:"216", p1:"117", r2:"337", p2:"192" },
      { tk:"AVGO", nm:"Broadcom", rs:"4/29 META CapEx 상향 + GOOGL TPU 8세대 8t/8i 수요 가속으로 4/28 OpenAI 컨센 하회發 -4% 일부 회복·MTIA·TPU 공동설계 백로그 $73B 견조", r1:"64", p1:"23", r2:"88", p2:"34" },
      { tk:"TSM", nm:"TSMC", rs:"Q1 $35.7B 확정·Q2 가이던스 $39~40.2B 상향·GM 65.5~67.5%·26년 USD +30%·CapEx 상단", r1:"117", p1:"55", r2:"153", p2:"70" },
      { tk:"ASML", nm:"ASML", rs:"Q1 €8.8B EPS €7.15 컨센 상회·수요>공급 지속·2026 €36~40B·EUV 독점", r1:"33", p1:"9", r2:"42", p2:"12" },
      { tk:"LRCX", nm:"Lam Research", rs:"HBM·NAND 장비", r1:"18", p1:"5", r2:"22", p2:"6.3" },
      { tk:"MU", nm:"Micron", rs:"5/5 장중 +11% 사상 최고 $651.74 - 245TB Micron 6600 ION SSD 본격 출하 발표·HDD 대비 랙 -82% 절감 AI·하이퍼스케일 수요·Gartner/IDC 2026 DRAM +125%·NAND +234% 'memflation' 내러티브 가속·HBM4 2Q 램프·26년 전량 완판", r1:"37", p1:"8", r2:"79", p2:"23" },
      { tk:"AMD", nm:"AMD", rs:"5/5 장후 Q1 매출 $10.3B +38% YoY 컨센 $9.84B 큰 폭 상회·EPS $1.37 vs $1.25 +9.6% 상회·DC 매출 $5.8B +57% YoY 가속·Q2 가이던스 $11.2B vs 컨센 $10.52B 큰 폭 상회·Lisa Su 'DC가 매출·이익 성장 1차 동인'·시간외 +5% 사상 최고 $379.90 도달", r1:"26", p1:"3.5", r2:"34", p2:"5.5" },
    ]
  },
  {
    title: "🏢 데이터센터",
    ...
    stocks: [
      ...
      { tk:"CRWV", nm:"CoreWeave", rs:"5/7 장후 Q1 발표·2026 매출 가이던스 $12~13B +140%·CapEx $30~35B 2025년 두 배·계약 백로그 $66.8B·Citi 목표가 $155 상향", r1:"5.1", p1:"-1.2", r2:"12.5", p2:"-0.5" },
  ...
  },
  {
    ...
    tag: "석유메이저·LNG·유전서비스",
    stocks: [
      { tk:"XOM", nm:"ExxonMobil", rs:"5/1 Q1 매출 $85.14B 컨센 $81.24B 상회·조정 EPS $1.16 컨센 $1.20 소폭 하회·GAAP EPS $1.00·순익 $4.2B vs $7.7B(-45%)·일회성 별도 시 $8.8B/EPS $2.09·Permian·Guyana 생산 가속·자사주 환원 유지", r1:"332", p1:"29", r2:"345", p2:"32" },
      { tk:"CVX", nm:"Chevron", rs:"5/1 Q1 조정 EPS $1.41 컨센 $0.97 +45% 압도(2020.10 이후 최대 상회폭)·매출 $48.61B 컨센 $51.39B 하회·순익 $2.2B vs $3.5B(-36%)·업스트림 $3.9B +4% Hess 통합 생산 +15%·차기 분기 자체 회복 가이던스", r1:"189", p1:"12", r2:"195", p2:"14" },
      { tk:"LNG", nm:"Cheniere", rs:"미 최대 LNG 수출·5/5 美 해군 호르무즈 美선박 2척 호위 통과로 Brent $112.85 -1.3%·WTI $103.78 -2.5% 일부 후퇴·5/4 이란 UAE 미사일 12발+드론 4발 공격 베이스 잔존·Fujairah 오일존 추가 피격 보고·유럽·아시아 LNG 프리미엄 일부 축소", r1:"16", p1:"3.5", r2:"18", p2:"4.2" },
  ...
  },
  {
    ...
    stocks: [
      ...
      { tk:"GM", nm:"General Motors", rs:"4/28 장전 Q1 매출 $44.02B 컨센 $43.03B 상회·EPS $2.78 컨센 $2.72 상회·트럼프 관세 협상 진행으로 풀해 가이던스 신뢰 철회·자사주 매입 일시 중단·$2B ASR Q2 마무리·컨콜 4/30로 연기", r1:"185", p1:"10", r2:"190", p2:"11" },
  ...
  },
  {
    ...
    stocks: [
      ...
      { tk:"MSTR", nm:"Strategy", rs:"5/5 장후 Q1 매출 $124.3M 컨센 $125M 부합·순손실 $12.54B BTC 공정가치 회계 영향·EPS -$38.25·BTC 보유 818,334개·Q1 ATM·STRC 등 자본 조달 $7.37B 라인 가속(STRC 4/1~5/3 추가 $3.51B)·BTC 5/5 $81K 돌파 1월 이후 첫 영역", r1:"0.5", p1:"-0.2", r2:"0.55", p2:"-0.15" },
  ...
  },
  {
    ...
    tag: "소비·금리 사이클 수혜",
    stocks: [
      { tk:"V", nm:"Visa", rs:"4/28 장후 Q2 FY26 매출 $11.23B 컨센 $10.96B 상회·조정 EPS $3.31 컨센 $3.09 상회·결제량 +9%·크로스보더 +12%·신규 $20B 자사주 매입 승인", r1:"40", p1:"20", r2:"43", p2:"22" },
  ...
  },
  {
    ...
    stocks: [
      ...
      { tk:"WFC", nm:"Wells Fargo", rs:"Q1 매출 21.5B·EPS 1.60 컨센 상회·대출 +11%·ROE 12.2%", r1:"83", p1:"19", r2:"88", p2:"22" },
    ]
  },
  {
    title: "🤖 로봇·자동화",
  ...
  },
  {
    ...
    tag: "방어+성장 혼합",
    stocks: [
      { tk:"AMZN", nm:"Amazon", rs:"4/29 장후 Q1 매출 $181.5B +17%·AWS $37.59B +28% 3년 만 최고 성장률 컨센 +26% 상회·AWS 영업익 $14.2B·EPS $2.78·Q2 가이던스 $194~199B +16~19%·연간 CapEx $200B 유지·이커머스 견조", r1:"717", p1:"78", r2:"800", p2:"95" },
