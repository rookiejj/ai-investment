...
const data = [
  ...
  },
  {
    ...
    tag: "석유메이저·LNG·유전서비스",
    stocks: [
      { tk:"XOM", nm:"ExxonMobil", rs:"4/26 Pezeshkian '협박·봉쇄 하 강요된 협상 거부' 공식화·Sharif 통화로 對美 강경 입장 정형화·트럼프 4/25 협상단 파키스탄行 막판 취소·전화 협상 전환·Brent $105.33 주간 +17%", r1:"332", p1:"29", r2:"345", p2:"32" },
      { tk:"CVX", nm:"Chevron", rs:"4/26 이란 대통령 '美 작전적 압박·봉쇄 해제가 선결' 못박아 협상 채널 사실상 동결·WTI $94.40 주간 +14%·호르무즈 통항 일평균 0척 근접 두 달 임박", r1:"189", p1:"12", r2:"195", p2:"14" },
      ...
      { tk:"COP", nm:"ConocoPhillips", rs:"상류 E&P·미·이란 직접 회담 무산으로 Brent·WTI 프리미엄 연장·주간 Brent +17%·WTI +14% 마진 확대 구간", r1:"60", p1:"10", r2:"64", p2:"11" },
  ...
  },
  {
    ...
    stocks: [
      ...
      { tk:"MSTR", nm:"Strategy", rs:"BTC 주말 $77.9~78.1K 박스 견고·이란 대통령 협상 거부 공식화에도 매수세 흡수·총 815,061 BTC 평단 $74,395 평가익 유지·달러 인덱스와 4년 최강 음의 상관 지속", r1:"0.5", p1:"-0.2", r2:"0.55", p2:"-0.15" },
