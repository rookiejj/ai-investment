...
const data = [
  ...
  },
  {
    ...
    tag: "AI칩·파운드리·장비·메모리",
    stocks: [
      { tk:"NVDA", nm:"NVIDIA", rs:"5/8 일중 $217.80 신고가·5/7 IREN 다년 5GW DSX 인프라 파트너십 - $3.4B 매니지드 GPU 클라우드 + 30M주 $70 워런트 $2.1B 투자 권리·5/6 Corning $500M 워런트 + 최대 $3.2B 광 인프라 투자·5/20 Q1 FY27 컨센 매출 $78.8B(+78.6%)·EPS $1.77(+118.5%) 카운트다운·Rubin 풀프로덕션", r1:"216", p1:"117", r2:"337", p2:"192" },
  ...
  },
  {
    ...
    stocks: [
      ...
      { tk:"COP", nm:"ConocoPhillips", rs:"4/30 장후 Q1 EPS $1.89 컨센 $1.62 상회·매출 $16.05B 컨센 상회·FCF $2.4B·생산 2.31M boe/d·자사주+배당 $2B 환원·Willow 프로젝트 50% 진척·5/6 美·이란 평화 합의 임박 보도로 Brent $98.30 -7% 후퇴·셰일 FCF 우호 베이스는 유지", r1:"60", p1:"11", r2:"64", p2:"12" },
  ...
  },
  {
    ...
    stocks: [
      ...
      { tk:"JOBY", nm:"Joby Aviation", rs:"전기 수직이착륙 도심항공·FAA 인증 절차 진척·우버·델타 협력", r1:"0.08", p1:"-0.50", r2:"0.30", p2:"-0.40" },
