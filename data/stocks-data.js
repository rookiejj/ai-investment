...
const data = [
  {
    ...
    stocks: [
      ...
      { tk:"PLTR", nm:"Palantir", rs:"5/4 장후 Q1 발표 D-1·컨센 매출 $1.54B +74% YoY·EPS $0.28 +115%·미 상업 매출 컨센 $771M +94%·옵션 ±10% 변동성 가격·Wedbush·Baird Buy 유지", r1:"4.5", p1:"0.6", r2:"7.2", p2:"1.5" },
  ...
  },
  {
    ...
    stocks: [
      ...
      { tk:"AMD", nm:"AMD", rs:"5/5 장후 Q1 발표 D-2·컨센 매출 $9.84B +32% YoY·EPS $1.30 +35%·MI450 하반기 캐파·OpenAI 주문 진척 단일 분기점·옵션 ±8% 변동성·D.A. Davidson 목표가 $375 상향", r1:"26", p1:"3.5", r2:"34", p2:"5.5" },
    ]
  },
  {
    title: "🏢 데이터센터",
  ...
  },
  {
    ...
    stocks: [
      ...
      { tk:"MSTR", nm:"Strategy", rs:"BTC 5/2 종가 $78,230 +2.5% - 주말 거래에서 장중 $78,961 고점 터치·CVD +11,500 BTC 2월 이후 최대 매수 유입·$80K 재시도 구간·총 818,334 BTC 평단 $75,537 평가익 회복·세일러 1M BTC 목표 유지", r1:"0.5", p1:"-0.2", r2:"0.55", p2:"-0.15" },
