...
const data = [
  ...
  },
  {
    ...
    tag: "AI칩·파운드리·장비·메모리",
    stocks: [
      { tk:"NVDA", nm:"NVIDIA", rs:"5/11 일중 $222.29 신고가 +2.6%·5/6 Corning 최대 $3.2B 광 인프라 투자(15M주 $180·美 3개 신공장 광 캐파 10배)·5/7 IREN 5GW DSX + $2.1B 투자 권리·Intel 위탁 제조 협업 부각·5/20 Q1 FY27 컨센 매출 $78.3B(+78%)·EPS $1.74 베이스에 골드만 $80.05B·$1.86 상향 시그널·애널 37인 매수 컨센 목표 $267.50 +24% 업사이드", r1:"216", p1:"117", r2:"337", p2:"192" },
  ...
  },
  {
    ...
    stocks: [
      ...
      { tk:"CSCO", nm:"Cisco", rs:"5/13 장후 Q3 FY26 D-1 - 가이던스 매출 $15.4~15.6B·EPS $1.02~1.04 컨센 상회 시그널·AI 인프라 주문 FY26 $5B+ 가이던스·Silicon One G300 102.4Tbps·Splunk H1 신규 로고 500개·옵션 ±8.7% 변동성", r1:"54", p1:"11", r2:"58", p2:"12.5" },
  ...
  },
  {
    ...
    tag: "석유메이저·LNG·유전서비스",
    stocks: [
      { tk:"XOM", nm:"ExxonMobil", rs:"5/11 시가 WTI $97.40 +2%·Brent $103.80 +2.5% 동반 강세 - 트럼프 5/10 이란 응답 'TOTALLY UNACCEPTABLE' 공식 거부에 호르무즈 봉쇄 10주차 장기화 가격·Q1 매출 $85.14B 컨센 상회·자사주 환원 유지·Permian·Guyana 생산 가속 베이스", r1:"332", p1:"29", r2:"345", p2:"32" },
      { tk:"CVX", nm:"Chevron", rs:"5/11 시가 wartime 마진 재확장 - 트럼프 5/10 이란 거부 + 이란 '결코 굴복 않는다' 표명에 Brent $103·WTI $97 동반 강세·Q1 조정 EPS $1.41 컨센 $0.97 +45% 압도(2020.10 이후 최대 상회폭) + Hess 통합 생산 +15% 베이스", r1:"189", p1:"12", r2:"195", p2:"14" },
      ...
      { tk:"COP", nm:"ConocoPhillips", rs:"4/30 장후 Q1 EPS $1.89 컨센 $1.62 상회·매출 $16.05B 컨센 상회·FCF $2.4B·생산 2.31M boe/d·자사주+배당 $2B 환원·Willow 프로젝트 50% 진첩·5/6 美·이란 평화 합의 임박 보도로 Brent $98.30 -7% 후퇴·셰일 FCF 우호 베이스는 유지", r1:"60", p1:"11", r2:"64", p2:"12" },
  ...
  },
  {
    ...
    stocks: [
      ...
      { tk:"UBER", nm:"Uber", rs:"5/6 프리마켓 +6~8% Q1 결과 - 매출 $11.5B +14% YoY·조정 EPS $0.72 컨센 $0.70 상회·총예약 $52~53.5B 가이던스·자사주 $3B 1Q 환원(전년 +66%)·OP 캐시플로우 $2.4B·FCF $2.3B·Q4 매출 $15.69B 가이던스·Waymo 로보택시 파트너십 +가이던스 동시 상향", r1:"47", p1:"5.5", r2:"54", p2:"7.0" },
  ...
  },
  {
    ...
    stocks: [
      ...
      { tk:"ASTS", nm:"AST SpaceMobile", rs:"위성-스마트폰 직통 LEO·BlueBird 양산 발사 가속·AT&T·버라이즌 파트너", r1:"0.05", p1:"-0.30", r2:"0.45", p2:"-0.25" },
  ...
  },
  {
    ...
    stocks: [
      ...
      { tk:"JOBY", nm:"Joby Aviation", rs:"전기 수직이착륙 도심항공·FAA 인증 절차 진첩·우버·델타 협력", r1:"0.08", p1:"-0.50", r2:"0.30", p2:"-0.40" },
