...
const data = [
  ...
  },
  {
    ...
    tag: "석유메이저·LNG·유전서비스",
    stocks: [
      { tk:"XOM", nm:"ExxonMobil", rs:"오늘 5/1 美 장전 Q1 결과 발표 임박 — 컨센 EPS $1.07 YoY -39%·매출 $81.5B·Brent 장중 $126→종가 $114 등락 속 업스트림 마진·생산량·자사주 환원 톤 점검대", r1:"332", p1:"29", r2:"345", p2:"32" },
      { tk:"CVX", nm:"Chevron", rs:"오늘 5/1 美 장전 Q1 결과 발표 임박 — 컨센 EPS $0.98 YoY -44%·매출 $51.86B·Downstream 일회성 차지 $2.7~3.7B 후세제 부담·Brent 장중 $126→종가 $114·핵 양보 없이 호르무즈 통항 거부 지속", r1:"189", p1:"12", r2:"195", p2:"14" },
      { tk:"LNG", nm:"Cheniere", rs:"미 최대 LNG 수출·호르무즈 봉쇄 두 달째·Brent 4/30 종가 $114·유럽·아시아 프리미엄 보존·재라우팅 수혜 분기 추가 연장·5/1 XOM·CVX Q1 동시 발표로 에너지 메이저 가이던스 톤 동반 점검대", r1:"16", p1:"3.5", r2:"18", p2:"4.2" },
