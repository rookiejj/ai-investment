...
const data = [
  ...
  },
  {
    ...
    stocks: [
      ...
      { tk:"AMD", nm:"AMD", rs:"5/5 장후 Q1 D-Day·컨센 매출 $9.84B +32% YoY·EPS $1.30 +35%·Q1 가이던스 $9.9B±$300M·GM 54% 가이던스·MI450 하반기 캐파 + OpenAI 6GW + Meta 6GW 주문 진척 단일 분기점·D.A. Davidson 목표가 $375·HSBC Hold 다운그레이드", r1:"26", p1:"3.5", r2:"34", p2:"5.5" },
    ]
  },
  {
    title: "🏢 데이터센터",
  ...
  },
  {
    ...
    stocks: [
      ...
      { tk:"LNG", nm:"Cheniere", rs:"미 최대 LNG 수출·5/4 이란 UAE 미사일 12발+드론 4발 공격·Fujairah 오일존 화재·ADNOC 유조선 Barakah 드론 2발 피격·휴전 깨질 수 있는 재격화로 Brent $114.44 +6%·WTI $106.42 +4% 급반등·유럽·아시아 LNG 프리미엄 추가 확장", r1:"16", p1:"3.5", r2:"18", p2:"4.2" },
  ...
  },
  {
    ...
    stocks: [
      ...
      { tk:"MSTR", nm:"Strategy", rs:"5/5 장후 Q1 D-Day·세일러 BTC 주간 매수 일시 중단 후 결과 발표·BTC 5/4 $80,617 3개월 고점 후 이란-UAE 미사일 공격으로 $79.8K 후퇴·총 818,334 BTC 평단 $75,537·옵션 ±8% 변동성·컨센 매출 $125M +12.5% YoY·EPS -$15.87 추정", r1:"0.5", p1:"-0.2", r2:"0.55", p2:"-0.15" },
