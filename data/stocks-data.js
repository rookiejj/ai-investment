...
const data = [
  ...
  },
  {
    ...
    tag: "AI칩·파운드리·장비·메모리",
    stocks: [
      { tk:"NVDA", nm:"NVIDIA", rs:"5/13 Wells Fargo 목표가 $265 → $315 상향 - 5/20 Q1 FY27 D-7 컨센 매출 $78.3B(+78%)·EPS $1.74 베이스에 골드만 $80.05B·$1.86 상향 시그널 그대로·시총 $5.4T·5/19 Computex 키노트 직전·트럼프 5/13 베이징 출국 Huang CEO 동행 對中 수출 가이던스 사이드 변수", r1:"216", p1:"117", r2:"337", p2:"192" },
  ...
  },
  {
    ...
    stocks: [
      ...
      { tk:"CSCO", nm:"Cisco", rs:"5/13 장후 Q3 FY26 D-Day 16:30 ET·5/12 종가 $98.72 +2.23% 사상 최고 - 가이던스 매출 $15.4~15.6B·EPS $1.02~1.04 컨센 $15.2B·$0.95 상회 시그널·AI 인프라 주문 FY26 $5B+ 중 $3B 하이퍼스케일러 매출 전환·기대치 신규 주문 $1.5B+·Silicon One G300 102.4Tbps·옥션 ±9.87% 변동성", r1:"54", p1:"11", r2:"58", p2:"12.5" },
