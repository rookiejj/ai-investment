...
const data = [
  ...
  },
  {
    ...
    tag: "석유메이저·LNG·유전서비스",
    stocks: [
      { tk:"XOM", nm:"ExxonMobil", rs:"4/30 Brent $123 +4% 2022.6 이후 최고 전쟁가·美군 트럼프에 對이란 군사옵션 브리핑 보도·재무부 中 화학물 조달업체 6곳 제재·핵합의 전 봉쇄 유지 + 군사 재가동 우려 급증·5/2 Q1 컨센 EPS $1.74", r1:"332", p1:"29", r2:"345", p2:"32" },
      { tk:"CVX", nm:"Chevron", rs:"4/30 WTI $111+ Brent $123 +4% 전쟁가 진입·美군 對이란 옵션 브리핑 보도·재무부 中 6곳 추가 제재·핵 양보 없는 통항 정상화 거부 + 군사 재가동 리스크·5/2 Q1 컨센 EPS $2.41", r1:"189", p1:"12", r2:"195", p2:"14" },
      { tk:"LNG", nm:"Cheniere", rs:"미 최대 LNG 수출·호르무즈 봉쇄 두 달째·4/30 Brent $123 +4% 전쟁가·美군 對이란 옵션 브리핑·유럽·아시아 프리미엄 추가 확장·재라우팅 수혜 분기 추가 보존", r1:"16", p1:"3.5", r2:"18", p2:"4.2" },
      ...
      { tk:"COP", nm:"ConocoPhillips", rs:"상류 E&P·4/30 Brent $123 +4% 전쟁가·美군 對이란 군사옵션 브리핑 보도·재무부 中 6곳 추가 제재·핵 양보 없는 통항 정상화 거부·셰일 마진 추가 확장", r1:"60", p1:"10", r2:"64", p2:"11" },
