...
const data = [
  ...
  },
  {
    ...
    tag: "EV·레거시·자율주행",
    stocks: [
      { tk:"TSLA", nm:"Tesla", rs:"4/22 장후 Q1 실적·컨센 매출 $22.27B EPS $0.25~0.37·인도 358k(컨센 372k 미스)·5만대 재고 오버행·에너지 스토리지 반토막 우려·Terafab CapEx 가이던스 관전", r1:"95", p1:"3.8", r2:"109", p2:"7.2" },
