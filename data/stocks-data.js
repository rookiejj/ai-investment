...
const data = [
  ...
  },
  {
    ...
    tag: "석유메이저·LNG·유전서비스",
    stocks: [
      { tk:"XOM", nm:"ExxonMobil", rs:"4/25 트럼프 Witkoff·Kushner 파키스탄行 막판 취소·'이란 내홍' 지목·전화 협상 전환·이란 봉쇄 해제 선결조건 고수로 결렬·Brent $105.33 주간 +17% 프리미엄 유지", r1:"332", p1:"29", r2:"345", p2:"32" },
      { tk:"CVX", nm:"Chevron", rs:"4/25 美 협상단 파키스탄 출발 직전 취소·이란 외무장관 이슬라마바드 떠난 1시간 뒤 결정·트럼프 '이란이 많이 양보했지만 충분치 않다'·WTI $94.40 주간 +14%·호르무즈 통항 정체 연장", r1:"189", p1:"12", r2:"195", p2:"14" },
  ...
  },
  {
    ...
    stocks: [
      ...
      { tk:"MSTR", nm:"Strategy", rs:"BTC 주말 $77.5K 박스 횡보·미·이란 회담 무산에 리스크오프 압력 잠재·총 815,061 BTC 평단 $74,395 평가익 유지·달러 인덱스와 4년 최강 음의 상관 지속", r1:"0.5", p1:"-0.2", r2:"0.55", p2:"-0.15" },
