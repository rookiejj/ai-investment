...
const data = [
  ...
  },
  {
    ...
    tag: "석유메이저·LNG·유전서비스",
    stocks: [
      { tk:"XOM", nm:"ExxonMobil", rs:"4/30 Brent 장중 $126 4년 최고 후 -3% $114 종가 차익실현·WTI $105·美군 對이란 옵션 브리핑 + 中 6곳 추가 제재 봉쇄 강화·전쟁가 변동성 확대 속 5/2 Q1 컨센 EPS $1.74 점검대", r1:"332", p1:"29", r2:"345", p2:"32" },
      { tk:"CVX", nm:"Chevron", rs:"4/30 Brent 장중 $126 4년 최고 후 차익실현으로 -3% $114 종가·WTI $105·美군 對이란 옵션 브리핑·中 6곳 추가 제재로 봉쇄 강화 + 핵 양보 없는 통항 거부·5/2 Q1 컨센 EPS $2.41", r1:"189", p1:"12", r2:"195", p2:"14" },
      { tk:"LNG", nm:"Cheniere", rs:"미 최대 LNG 수출·호르무즈 봉쇄 두 달째·4/30 Brent 장중 $126 4년 최고 후 -3% $114 종가 차익·유럽·아시아 프리미엄 추가 확장·재라우팅 수혜 분기 추가 보존", r1:"16", p1:"3.5", r2:"18", p2:"4.2" },
