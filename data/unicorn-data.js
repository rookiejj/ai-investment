...
const data = [
  ...
  },
  {
    ...
    stocks: [
      { nm:"SpaceX", rs:"Musk 2025 직원 $1.4B 매입 공시·이중의결권 Class B 10표·6.6T 밸류시 수천만주 추가 부여·4/21~23 애널리스트 투어·$75B 조달·6/8 로드쇼", val:"$1.25T", round:"S-1 비밀 제출·리테일 30% 할당(UK·EU·호주·캐나다·일본·한국)", sector:"우주", ipo:"2026.06 프라이싱·$1.75T" },
