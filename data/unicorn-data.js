const data = [
  ...
  },
  {
    ...
    "stocks": [
      {
        "nm": "SpaceX",
        "rs": "S-1 공개 5/18(월) D-1 카운트다운 + Starship V3 첫 비행 5/19 Starbase Pad 2 - Flight 12·Raptor 3 엔진(해수면 250tf·진공 275tf) 업그레이드·22 Starlink 시뮬레이터 배포·서브오비탈 테스트, 6/8 주간 로드쇼·6/11 프라이싱·6/12 Nasdaq 데뷔 시나리오·목표 $1.75T~$2T·조달 $75B 사상 최대·MS·BofA·Citi·JPM·GS 리드 21개 주관사·30% 리테일 트랜치 ~$22.5B·Starlink 2025 이익 $4.4B 더블",
        "ipo": "2026.06.11 프라이싱·6/12 Nasdaq 데뷔",
        "val": "$1.75T",
        "round": "S-1 공개 5/18(월) D-1·리테일 30% 할당(UK·EU·호주·캐나다·일본·한국)",
        "sector": "우주"
      },
      {
        "nm": "Zipline",
