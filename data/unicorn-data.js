const data = [
  {
    ...
    "stocks": [
      {
        "nm": "Stripe",
        "rs": "5/11 함의 $100B+ 도달 - 2025 텐더 $65B 베이스 +50% 단일 사이클·Tempo L1 메인넷 가동·Visa·Zodia 첫 외부 밸리데이터·결제 인프라 1위·TPV $1.9T·2H 2026 IPO 윈도우 잔존",
        "ipo": "2H 2026 윈도우",
        "val": "$159B",
        "round": "2/26 텐더오퍼",
        "sector": "결제"
      ...
      {
        "nm": "Revolut",
        "rs": "CEO Storonsky 4/20 IPO 2028+ 연기 공식화·2026 매출 $9B·순익 $3.5B 목표",
        "ipo": "2028+ 연기",
        "val": "$75B",
        "round": "세컨더리 $100B 추진",
        "sector": "네오뱅크"
  ...
  },
  {
    ...
    "stocks": [
      ...
      {
        "nm": "Discord",
        "rs": "4/28 Polymarket 6/30까지 IPO 확률 20%로 후퇴·세컨더리 밸류 $7~10B로 2021 피크 $15B에서 재평가·ARR $7억+·MAU 2억+ 펀더멘털 견조하나 시장 변동성에 일정 지연",
        "ipo": "2026 H2로 후퇴",
        "val": "$10B",
        "round": "Series I (세컨더리 다운라운드)",
        "sector": "소셜"
      },
      {
        "nm": "Airtable",
  ...
  },
  {
    ...
    "stocks": [
      {
        "nm": "SpaceX",
        "rs": "S-1 공개 윈도우 5/15~22 본격 진입 D-Day~7 - 4/1 SEC 비공개 등록 + 15일 사전 공개 룰 + 6/8 로드쇼 카운트다운·6/18~30 프라이싱·목표 $1.75~2.0T·$75B 조달·5/6 Colossus 1 전체 컴퓨트(300MW·NVIDIA GPU 220K) Anthropic 단독 임대(연 매출 $3~4B 추정)·5/14 Musk 베이징 트럼프 동행단 IPO 직전 외교 채널",
        "ipo": "2026.06.18~30 프라이싱·$1.75T",
        "val": "$1.25T",
        "round": "S-1 비밀 제출·리테일 30% 할당(UK·EU·호주·캐나다·일본·한국)",
        "sector": "우주"
      },
      {
        "nm": "Zipline",
