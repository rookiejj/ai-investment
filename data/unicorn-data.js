...
const data = [
  {
    ...
    tag: "결제·뱅킹·HR·SMB",
    stocks: [
      { nm:"Stripe", rs:"5/8 WLFI USD1 스테이블코인 Tempo L1 첫 네이티브 발행(TIP-20) - 3/18 메인넷 가동 후 2개월 내 정량 입증·Tempo Series A $500M $5B 밸류(Thrive·Greenoaks)·2/24 텐더 $159B·TPV $1.9T·2H 2026 IPO 윈도우 잔존", val:"$159B", round:"2/24 텐더오퍼", sector:"결제", ipo:"2H 2026 윈도우" },
  ...
  },
  {
    ...
    stocks: [
      ...
      { nm:"Figure AI", rs:"휴머노이드 로봇·Series D $48B 클로징·Amazon 20K + Mercedes 50K 누적 주문 파이프라인 70K+ 유닛 / $14B+ 매출(2029까지)·생산 월 1,200대→Q4 5,000대·BMW 공장 90K+ 파트 로딩", val:"$48B", round:"Series D 클로징 (2026-04)", sector:"휴머노이드 로봇", ipo:"미정" },
    ]
  },
  {
    title: "🧬 바이오·헬스",
