...
const data = [
  {
    ...
    stocks: [
      ...
      { nm:"Thinking Machines Lab", rs:"Murati 창업·Tinker API·$50B 신규 라운드 협상 중", val:"$12B", round:"Seed ($2B, 2025-07)", sector:"멀티모달 AI", ipo:"미정" },
  ...
  },
  {
    ...
    stocks: [
      ...
      { nm:"Anduril", rs:"방산 AI·자율무기·Lattice OS·美 육군 $20B 계약", val:"$60B", round:"Series G", sector:"방산 AI", ipo:"2026 검토" },
  ...
  },
  {
    ...
    tag: "거래소·인프라·분석·커스터디",
    stocks: [
      { nm:"Kraken", rs:"크립토 거래소 3위·IPO 비밀 신청(4/14)·Deutsche Börse $200M", val:"$13.3B", round:"IPO 비밀 신청 (4/14)", sector:"크립토 거래소", ipo:"2026 H2" },
