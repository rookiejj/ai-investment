...
const data = [
  {
    ...
    stocks: [
      ...
      { nm:"Anthropic", rs:"Claude·ARR $30B·OpenAI 추월", val:"$380B", round:"Series H ($30B)", sector:"프론티어 AI", ipo:"2026.10 $400B+" },
  ...
  },
  {
    ...
    stocks: [
      ...
      { nm:"Ramp", rs:"법인카드·지출관리·AI 자동화", val:"$13B", round:"Series D", sector:"법인 핀테크", ipo:"미정" },
      { nm:"Plaid", rs:"금융 데이터 API·오픈뱅킹", val:"$8B", round:"텐더오퍼 (다운)", sector:"핀테크 인프라", ipo:"2026 말" },
      { nm:"Navan", rs:"법인 출장·경비 통합 플랫폼", val:"$9.4B", round:"Series H", sector:"법인 핀테크", ipo:"2027" },
    ]
  },
  {
    title: "🏢 엔터프라이즈 SW",
    tag: "생산성·디자인·협업",
    stocks: [
      { nm:"Canva", rs:"디자인 플랫폼·AI 생성·ARR $4B", val:"$42B", round:"세컨더리", sector:"디자인", ipo:"2027" },
      { nm:"Perplexity AI", rs:"AI 검색·답변 엔진·ARR $200M+", val:"$20B", round:"Series E", sector:"AI 검색", ipo:"2027" },
  ...
  },
  {
    ...
    stocks: [
      ...
      { nm:"Stoke Space", rs:"완전 재사용 로켓·2단 회수", val:"$3B", round:"Series D", sector:"우주", ipo:"미정" },
  ...
  },
  {
    ...
    stocks: [
      ...
      { nm:"Cohere", rs:"엔터프라이즈 LLM·ARR $240M", val:"$6.8B", round:"Series D ($500M)", sector:"엔터프라이즈 AI", ipo:"2026 CFO영입" },
      { nm:"Xaira Therapeutics", rs:"AI 신약 발굴·ARCH·NVIDIA", val:"$1B+", round:"론칭 라운드 ($1B)", sector:"AI 바이오", ipo:"미정" },
    ]
  },
  {
    title: "₿ 크립토·Web3",
    tag: "스테이블코인·인프라·분석",
    stocks: [
      { nm:"Kraken", rs:"크립토 거래소 3위·IPO 추진", val:"$12B", round:"자체 수익", sector:"크립토 거래소", ipo:"2026 IPO" },
      { nm:"Ripple", rs:"XRP·크로스보더 결제·Citadel 투자", val:"$40B", round:"$500M (Citadel·Fortress)", sector:"블록체인 결제", ipo:"$50B IPO 전망" },
