const data = [
  ...
  },
  {
    ...
    "stocks": [
      {
        "nm": "SpaceX",
        "rs": "6/8 로드솼·6/11 프라이싱·6/12 Nasdaq 데뷔 SPCX D-15 - 6/7 21개 IB 125명 애널리스트 데이·6/11 리테일 투자자 1,500명 IR·골드만샭스 lead·MS·BofA·Citi·JPM 공동 주관·조달 $75B+(2019 사우디 아람코 $29.4B 추월 사상 최대)·밸류 $1.75T~$2T·머스크 85.1% 의결권 거버넌스 변수",
        "ipo": "2026.06.12 Nasdaq 데뷔 (6/8 로드솼·6/11 프라이싱)",
        "val": "$1.75T~$2T",
        "round": "5/20 S-1 공개·티커 SPCX·골드만 lead·6/7 IB 데이·6/8 로드솼·6/11 리테일 1,500명 IR",
        "sector": "우주"
      },
      {
        "nm": "Zipline",
