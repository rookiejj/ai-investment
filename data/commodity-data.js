...
const data = [
  {
    ...
    tag: "안전자산·인플레 헤지",
    stocks: [
      { tk:"GC", nm:"금 (Gold)", rs:"중앙은행 매입·지정학 리스크·$4,800 돌파", price:"$4,787", ytd:"+32%", y1:"+55%", range:"$3,100–4,820" },
  ...
  },
  {
    ...
    tag: "원유·천연가스·석탄",
    stocks: [
      { tk:"CL", nm:"원유 WTI", rs:"호르무즈 봉쇄·$95 돌파", price:"$95", ytd:"+28%", y1:"+42%", range:"$65–101" },
      { tk:"BZ", nm:"브렌트유", rs:"호르무즈 봉쇄·$100 돌파", price:"$101", ytd:"+30%", y1:"+45%", range:"$70–105" },
