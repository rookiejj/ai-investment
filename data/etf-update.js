...
美 선물 약보합 출발 — 4/29 메가캡 4사·4/30 FOMC 직전 관망
구리 $6.03/lb·중국 탄산리튬 176,000 CNY/t 신고가 LIT 우호적 환경`,
    changes: [
      { type: "정보 갱신", sector: "신흥국·글로벌",
        detail: "EWY. 4/28 화요일 오전 KOSPI가 6,643.86 +0.44%로 출발해 6,700선 돌파를 시도, SK하이닉스 +2.48% 1,320,000원대로 사상 최고가를 4/27 1,290,000원에서 하루 만에 추가 갱신했고 삼성전자도 +0.89% 224,000원대로 동조 강세. 외국인·기관 매수가 시총 상위 반도체·AI에 집중되며 한국 거래소 시총 6,100조원 진입 시도, 코스닥은 -1.2% 차익실현 매도로 디커플. EWY는 YTD +58%·1Y +154% 모멘텀을 연장하면서 4/29 GOOGL·MSFT·META·AMZN 동시 실적 + 4/30 FOMC가 다음 변곡점 — 메가캡 클라우드 CapEx 톤이 한국 메모리 듀오의 가이던스 수용력을 사전 결정.", time: "2026-04-28 13:00 KST" },
      { type: "정보 갱신", sector: "클린에너지",
        detail: "LIT(Global X Lithium & Battery). 4/27 중국 탄산리튬 가격이 176,000 CNY/t으로 +1.73% 상승하며 월간 +6.99%·연간 +155.63%를 기록, 미국 달러 환산 시 24,200 USD/t 부근 신고가 영역. EV·ESS 재고 소진 국면 + 호주·중국 광산 일부 감산 영향이 누적되며 공급 부족 우려가 가격에 빠르게 반영, LFP 셀 가격 인상 압력으로 작동. ALB·SQM·LAC 등 LIT 핵심 보유 종목에 직접 호재로, K-배터리(LG에너지솔루션·삼성SDI)와 동조하는 마진 회복 트레이드의 핵심 변수.", time: "2026-04-28 13:00 KST" },
    ]
  },
  {
    date: "2026-04-28 07:24 KST",
    summary: "美 4/27 마감 S&P 7,173.91 +0.12%·Nasdaq 24,887.10 +0.20% 동반 신고가·NVDA $216.57 +4% QCOM·OpenAI·MediaTek 2028 AI 스마트폰 칩 보도로 SMH·SOXX 동반 강세·OpenAI·MS 독점 종료 합의로 AWS·GCP·Oracle 직접 호스팅 가능·Brent $107·WTI $95대 박스·BTC $80K 저항 8일째",
    changes: [
      { type: "정보 갱신", sector: "AI·반도체",
        detail: "SMH·SOXX. 4/27 NVDA가 +4.0% $216.57 사상 최고로 마감 시총 $5.3T 돌파, QCOM은 +11~12% 동반 점프했다. 트리거는 Ming-Chi Kuo의 일요일 X 게시글에서 OpenAI·QCOM·MediaTek·Luxshare 4사가 2028 AI 네이티브 스마트폰 칩을 공동개발한다는 보도. AI 컴퓨트가 데이터센터에서 모바일 엣지로 확장되는 첫 메인스트림 시그널로 해석돼 칩 ETF 전반에 매수 압력. 4/29 GOOGL·MSFT·META·AMZN 동시 실적이 클라우드 CapEx 톤을 결정해 NVDA·AVGO·MU의 5월 가이던스 수용력을 사전 결정하는 마지막 점검대. SMH 4월 누적 +22% 수준 유지.", time: "2026-04-28 07:24 KST" },
      { type: "정보 갱신", sector: "미국 대형주",
        detail: "SPY·QQQ. 4/27 S&P 500이 7,173.91 +0.12%·Nasdaq 24,887.10 +0.20%로 동반 사상 최고 마감, 다우는 -62.92p(-0.13%) 49,167.79로 후퇴해 빅테크·반도체 주도 분산 흐름. VZ Q1 매출 $34.4B +2.9%·조정 EPS $1.28 +7.6% 컨센 비트·풀해 EPS 가이던스 +5~6%로 상향에 +3.5% 반응, DPZ는 컨센 미스로 -10.5% 급락. OpenAI·MS 7년 파트너십 전면 개편(독점 종료·AGI 조항 폐기·매출 셰어 한도)이 동시 발표돼 빅테크 자본배분 흐름이 한 차례 재편. 4/29 메가캡 4사 동시 실적 + 4/30 FOMC 동결 + 5/1 AAPL + 5/2 PCE 슈퍼위크 진입.", time: "2026-04-28 07:24 KST" },
      { type: "정보 갱신", sector: "에너지·원자력",
        detail: "XLE·VDE·XOP. 4/27 트럼프가 워싱턴에서 안보·외교팀 회의를 열어 이란이 전달한 호르무즈 재개방+종전 우선·핵협상 분리 패키지를 검토했지만 백악관은 '훨씬 좋아진 제안이지만 받아들일 가능성은 낮다'고 톤을 흘렸다. 핵 양보 없이 봉쇄를 풀면 레버리지가 사라진다는 우려가 핵심. 휴전은 추가 연장. Brent $107·WTI $95대 박스 상단 유지, 호르무즈 통항 정상화는 2H 2026으로 후퇴 컨센서스. 정유 마진 확장 분기·LNG 유럽 프리미엄 $19/MMBtu가 한 분기 추가 연장될 토대 강화.", time: "2026-04-28 07:24 KST" },
      { type: "정보 갱신", sector: "크립토·블록체인",
        detail: "IBIT·FBTC. 4/27 BTC가 $77,500~79,500 박스에서 마감, $80,000 저항을 8거래일 연속 돌파하지 못했다. 매물대 상단에 매도 집중. 다만 美 현물 BTC ETF는 8거래일 연속 순유입으로 누적 $21억 추가, 총 자산 $1,020억 신고가 유지. CoinDesk는 BTC와 USD 인덱스의 음의 상관 -0.91이 4년 최강을 유지 중이라 보도. 4/30 FOMC가 동결 신호 강화 시 USD 약세 시나리오와 함께 $80K 재돌파 시도 재점화 가능. ETHA는 디커플링 순유출 지속.", time: "2026-04-28 07:24 KST" },
    ]
  },
  {
    date: "2026-04-27 19:20 KST",
    summary: "KOSPI 6,615 +2.15% 사상 최고·한국 시총 6,000조원 첫 돌파·EWY +58% YTD 모멘텀 연장·일본 닛케이 +1.4% 신고가·BTC $79K $80K 근접 IBIT 8거래일 연속 순유입·美 선물 -0.1% 약세 출발·SOXX 4월 +28.77% 25년 史上 최대 월간 수익률·SMH 4월 +21.91% 2003년 11월 이후 최대",
    changes: [
      { type: "정보 갱신", sector: "신흥국·글로벌",
        detail: "EWY. 4/27 한국 KOSPI가 +2.15% 6,615.03으로 사상 최고 마감, 한국 거래소 시총 6,000조원(약 4.1조 달러)을 첫 돌파. 외국인·기관 합산 1.99조원 순매수, 개인은 1.97조원 차익실현. SK하이닉스 +5.56% 1,290,000원 사상 최고가·시총 글로벌 17위 진입 + 삼성전자 +1.37% 222,500원이 직접 견인했고, 한화에어로스페이스 +3.09%·현대로템·LIG넥스원·풍산이 K-방산 동반 강세로 받쳐줬다. 일본 닛케이 +1.4% 신고가·대만 가권 동반 강세까지 결합돼 EWY YTD +58% 모멘텀 연장 — 다만 미국 선물은 -0.1% 약세 출발로 갈림길.", time: "2026-04-27 19:20 KST" },
      { type: "정보 갱신", sector: "AI·반도체",
        detail: "SOXX·SMH. 4/24까지 SOXX가 17거래일 연속 상승해 4월 한 달 +28.77% — 25년 펀드 역사상 최대 월간 수익률, SMH는 +21.91%로 2003년 11월 이후 최대 월간 수익. 4월 신규 자금 유입은 SOXX $20.5억(직전 기록의 두 배)·SMH $34억으로 양 ETF 모두 사상 최대 월간 인플로우. NVDA가 YTD +7%로 전체 칩 섹터 대비 부진한 사이 자금이 메모리·아날로그·파운드리·아키텍처 경쟁사로 분산되는 섹터 로테이션 가속, 4/29 GOOGL·MSFT·META·AMZN 동시 실적이 클라우드 CapEx 톤을 결정하며 NVDA의 5/20 Q1 FY27 가이던스 수용력을 사전 결정.", time: "2026-04-27 19:20 KST" },
      { type: "정보 갱신", sector: "크립토·블록체인",
        detail: "IBIT·FBTC. 4/27 BTC가 $79,032 부근까지 반등해 $80K 저항선에 다시 근접, 美 현물 BTC ETF 8거래일 연속 순유입(누적 $21억)·출시 이후 누적 순유입 $580억·총 자산 $1,020억 사상 최대 + 달러 인덱스와 -0.91 4년 최강 음의 상관이 강세 토대. 다음 주 4/29~30 메가캡 슈퍼위크·FOMC 동결 시그널이 USD 약세 시나리오로 굳어지면 BTC 'macro 헤지' 재정의가 한 단계 더 강화될 구간, ETHA(이더리움 현물)는 디커플링 순유출이 이어져 종목별 차별화.", time: "2026-04-27 19:20 KST" },
    ]
  },
  {
    date: "2026-04-27 13:30 KST",
    summary: "이란 4/27 호르무즈 재개방+종전 신제안 미국에 전달·핵협상은 후순위 분리·트럼프 월요일 Situation Room 안보팀 소집·SK하이닉스 Q1 매출 52.6조·OP 37.61조·순익 40.35조 트리플 사상 최대 EWY 모멘텀 연장",
    changes: [
      { type: "정보 갱신", sector: "에너지·원자력",
        detail: "XLE·VDE·XOP. 4/27 Axios 보도로 이란이 미국에 새 협상 패키지를 제안한 사실이 공개. 핵심은 호르무즈 해협 재개방·즉각 종전을 우선 처리하고, 우라늄 농축 중단·재고 양도 등 핵 협상은 차후로 분리하는 구조. 4/26 페제시키안의 협상 거부 공식화를 한 단계 누그러뜨리는 후속 시그널이지만, 트럼프 측은 핵 양보 없이 봉쇄를 풀면 레버리지가 사라진다는 우려로 신중. 백악관 대변인은 '민감한 외교는 언론으로 협상하지 않는다'며 공식 입장 자제, 트럼프는 월요일 Situation Room에 안보·외교팀 전원 소집한다. 시장은 4/26 일요 야간 선물에서 회담 정체로 갭다운 후 4/27 신제안 노출에 양면 변동성, Brent $105.7·WTI $94.4 박스 유지. XLE·VDE·XOP는 마진 확대 분기 한 분기 연장 가정으로 굳어진 가운데 합의 클로징 신호 시 정유 마진 정상화 트레이드 회귀가 빠르게 작동할 구간.", time: "2026-04-27 13:30 KST" },
      { type: "정보 갱신", sector: "신흥국·글로벌",
        detail: "EWY. SK하이닉스 Q1 2026 트리플 사상 최대 — 매출 52.6조원(+198% YoY), 영업이익 37.61조원(+405% YoY), 순이익 40.35조원, 영업이익률 72%·순마진 77% 확정으로 메모리 슈퍼사이클이 한국 반도체 ETF의 NAV를 추가 부양. SK하이닉스가 평균 직원 1인당 약 7,000만원 분기 보너스를 책정하면서 삼성전자·현대차 노조도 동등 수준 인상안을 즉시 요구해 한국 빅테크 인건비 사이클이 메모리 슈퍼사이클을 따라 재정렬. 한국 4월 첫 10일 수출 252억 달러 +36.7%·반도체 85.7억 달러 +152.5% 사상 최고가 거시 기반을 보강하면서 EWY YTD +55% 모멘텀 연장 구간.", time: "2026-04-27 13:30 KST" },
      { type: "실적 예정", sector: "AI·반도체",
        detail: "QQQ·AIQ·SOXX·SMH. 4/29 장후 GOOGL·MSFT·META·AMZN 4사 동시 Q1 실적 발표, 4/30 AAPL이 마무리. 4월 한 달 GOOGL·AMZN·META·MSFT 모두 +10% 이상 상승, AAPL +6%로 가격에 기대치가 이미 선반영 — 한 곳이라도 미달 시 변동성 확대. NVDA YTD +7%로 MU +69%·AMD +43%·TSM +26% 대비 부진해 자금이 메모리·아날로그·파운드리·아키텍처 경쟁사로 분산되는 섹터 로테이션 흐름이 SMH·SOXX 내부 비중 재편을 초래, 단일 종목 의존도가 낮은 SMH·SOXX 대비 NVDA 비중이 큰 AIQ가 상대 부진 가능 구간.", time: "2026-04-27 13:30 KST" },
    ]
  },
  {
    date: "2026-04-27 07:50 KST",
    summary: "트럼프 4/25 백악관 출입기자단 만찬 총격 사건 후 무사 대피·31세 콜 토마스 앨런 체포·Pezeshkian '협박·봉쇄 하 강요된 협상 거부' 공식화·Meta 8,000명·Microsoft 사상 첫 바이아웃 8,750명 양사 동시 구조조정·4/29 메가캡 4사 슈퍼위크 진입",
    changes: [
      { type: "정보 갱신", sector: "미국 대형주",
        detail: "SPY·QQQ. 4/25 저녁(현지) 트럼프 대통령이 워싱턴 힐튼호텔 백악관 출입기자단 만찬 도중 총성으로 긴급 대피하는 사건 발생, 트럼프·내각 모두 무사하나 보안 검색대 밖에서 발사된 산탄총·소형총에 경관 1명이 방탄복으로 명중당해 회복 중. 캘리포니아 31세 콜 토마스 앨런이 체포돼 '트럼프 행정부 관리 표적' 진술. 4/29 장후 MSFT·META·AMZN·GOOGL 4사 동시 Q1 발표 + 4/30 FOMC + 5/1 PCE + 5/2 고용지표 슈퍼위크 진입을 앞두고 정치 리스크가 추가 변수로 결합. S&P 500 7,165·Nasdaq 24,836 기록 신고가 직후 진입한 변동성 재점화 구간이며 SPY·QQQ는 24~48시간 내 정상화 패턴 유력하나 단기 변동성 4중 트리거 진입.", time: "2026-04-27 07:50 KST" },
      { type: "구조조정", sector: "AI·반도체",
        detail: "QQQ·AIQ·SOXX. 4/23 빅테크 양사 동시 구조조정 발표 — Meta 8,000명(전체 10%) 정리 5/20 시행, Microsoft 51년 사상 첫 자발적 바이아웃으로 美 인력 7%(약 8,750명) 신청 옵션 제공. 합산 23,000+ 포지션 제거 또는 미충원으로 'payroll → AI capex' 전환을 명시적으로 가속 — Meta CapEx $115~135B(2025년 $72B의 2배)·Microsoft FY26 $110~120B을 NVIDIA GPU·자체 칩·데이터센터에 집중 투입. AI·반도체 ETF에는 인프라 수요 확실성을 재확인하는 호재로 작동하지만 마진 회수 톤이 4/29 동시 실적에서 검증대 통과해야 모멘텀 연장.", time: "2026-04-27 07:50 KST" },
      { type: "정보 갱신", sector: "에너지·원자력",
        detail: "XLE·VDE·XOP. 4/26 이란 대통령 페제시키안이 파키스탄 총리와의 통화에서 '협박·봉쇄 하의 강요된 협상에 들어가지 않겠다'고 공식화하며 4/25 트럼프의 협상단 파견 취소에 대한 이란 측 답을 정형화 — 호르무즈 봉쇄 해제를 선결조건으로 명문화해 협상 채널이 사실상 동결됐다는 평가. Bloomberg는 두 달째에 접어드는 충돌이 글로벌 GDP 성장률 추가 하향과 맞물리고 있다고 보도하며 1H 2026 회복 시나리오는 폐기 단계. 호르무즈 통항 일평균 0척 근접해 4/24 종가 Brent $105.33·WTI $94.40 프리미엄은 4/27 시장 개장에서 추가 갭업 압력으로 작동, XLE·VDE·XOP 모멘텀 연장.", time: "2026-04-27 07:50 KST" },
    ]
  },
  {
    date: "2026-04-26 19:20 KST",
    summary: "美 현물 BTC ETF 8거래일 연속 순유입 누적 $21억·출시 이후 누적 순유입 $580억·총 자산 $1,020억 돌파·BlackRock IBIT 단독 +$9억·Ether ETF $7,594만 순유출 디커플링·韓 단일종목 ±2x 레버리지 ETF 5/22 상장 첫 허용",
    changes: [
      { type: "정보 갱신", sector: "크립토·블록체인",
        detail: "IBIT·FBTC. 4/23 기준 미국 현물 비트코인 ETF가 8거래일 연속 순유입을 기록해 누적 $21억 흡수, 출시 이후 누적 순유입은 $580억·총 자산은 $1,020억을 사상 첫 돌파. BlackRock IBIT 단독으로 $9억+ 유입을 견인하며 시장 심리는 'Fear → Optimism' 전환. 같은 기간 단기 보유자 일부는 매도세로 전환했지만 기관 매수가 압도적으로 흡수해 BTC $77~78K 박스권을 견고하게 유지. 동기간 Ether 현물 ETF는 $7,594만 순유출로 디커플링 — 다음 주 메가캡 슈퍼위크와 4/30 FOMC 시그널이 BTC·ETH 상대강도 변곡점.", time: "2026-04-26 19:20 KST" },
      { type: "정보 갱신", sector: "신흥국·글로벌",
        detail: "EWY. 4/26 한국 금융투자업계 보도 — 4/21 국무회의가 자본시장법 시행령 개정안을 의결해 단일종목 레버리지·인버스 ETF 국내 상장이 사상 처음 허용. 자격 요건(평균 시총 10%+·거래대금 5%+·파생 거래량 1%+)을 충족하는 종목은 1Q 기준 삼성전자(시총 비중 약 22%)·SK하이닉스(약 15%) 단 두 곳, ±2x 레버리지·인버스 4종이 5/22까지 동시 상장 예정. EWY는 한국 메모리 2강 비중이 절대적이라 국내 신규 ETF 자금이 양방향으로 늘어나면 EWY 변동성·일중 추적오차 확대 가능, 다만 K-반도체 글로벌 베팅 채널 다변화로 장기 모멘텀 강화 효과.", time: "2026-04-26 19:20 KST" },
    ]
  },
  {
