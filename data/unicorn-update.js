    ...
    "changes": [
      {
        ...
        "type": "마일스톤",
        "detail": "SpaceX. 5/22 22:30 UTC Starship V3 Flight 12 발사 성공 - Pad 2 첫 발사·Raptor 3 33기 가동·Ship 단일 엔진 손실에도 인도양 splashdown 계획대로·22개 모의 스타링크 배치 + 2개 카메라 프로브 열차폐 관측·V3 하드웨어 데뷔 단일 마일스톤(Space·CNN 5/22). Super Heavy 부스트 백 번 실패 멕시코만 추락도 회수 비계획이라 미션 영향 제한. 6/11 프라이싱·6/12 Nasdaq 데뷔 SPCX D-20 - Starlink Q1 2026 매출 $3.3B·구독자 10.3M +106% YoY 베이스에서 V3 안정 가동 확인이 프라이싱 직접 모멘텀. 일부 분석가 $80B 조달·$2T 밸류 시나리오, 베이스 $75B 조달 $1.75T 골격 유지 - Brookfield $2B + 리테일 30% 배정.",
        "sector": "우주·모빌리티·방산"
      },
      {
