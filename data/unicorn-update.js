...
Sierra·Cursor 베이스에서 후기 단계 AI 자본 환경 우호 흐름 유지`,
    changes: [
      ...
      { type: "정보 갱신", sector: "엔터프라이즈 SW",
        detail: "Cursor·Perplexity·Notion 등 엔터프라이즈 AI 에이전트 카테고리 베이스. 5/5 OpenAI x PwC 글로벌 재무 운영 파트너십 + Anthropic 금융 서비스 AI 에이전트 10종 + Claude의 MS Excel·PPT 통합 + 양사 인도 동시 진출 = 단일 24h 윈도우에 글로벌 엔터프라이즈 AI 채널 양강 선점이 가속. 본 카테고리 후기 단계 AI 펀더멘털 베이스 우호 흐름 유지 - Cursor의 SpaceX $60B 옵션 베이스, Perplexity의 ARR $500M +335% YoY 베이스, Notion의 AI 워크스페이스 베이스 모두 매출·자본 동반 가속. 다음 분기점 - Anthropic $900B 라운드 5월 보드 미팅 결정 + SpaceX IPO 6월 프라이싱 + Cursor 자체 라운드 클로징.",
        time: "2026-05-06 07:25 KST" },
    ]
  },
  {
