const updates = [
  {
    ...
    "changes": [
      ...
      },
      {
        ...
        "type": "가격 반등",
        "sector": "에너지",
        "detail": "원유·천연가스. WTI 77.78달러대 반등·브렌트 83.23달러대 유지 - 이란·미국 호르무즈 재긴장 관측(양측 화력 교환 보도)·미 EIA 재고 감소 확인이 OPEC+ 9월 증산 하방 압력 상쇄, 8/6 발표 재고 데이터가 여름 드라이빙 수요 확인 축. 카타르 중재 하 호르무즈 부분 재개 서사와 재긴장 관측 병존 국면이 프리미엄 유지, J.P. Morgan Global Research Q3 브렌트 74달러 하향 조정 여지 유지가 상단 저항. 천연가스 2.75달러/MMBtu 저점권·Freeport LNG 정비 8월 말·냉방 수요 시즌 프리미엄 대기, 유럽 TTF 32유로/MWh 유지. 다음주 8/12 CPI·8/13 PPI 발표 대기가 인플레 완화 시나리오 방향타. 매크로 렌즈 - 지정학 리스크 재점화가 에너지 프리미엄 방어 축, 크로스에셋 렌즈 - 유가 반등이 gold·silver 랠리와 병존 국면."
      },
      {
        "time": "2026-08-09 07:00 KST",
        "type": "가격 사상 최고",
        "sector": "산업금속",
        "detail": "구리·알루미늄·니켈·철광석. 구리 COMEX 6.7달러/lb 사상 최고 갱신·LME 3M 14,800달러/t 신고가 - 글로벌 공급 리스크 확대 지속·J.P. Morgan·ICSG 데이터센터 47.5만톤 수요 확정·2026 33만톤 정제 구리 부족 전망이 하이퍼스케일러 CAPEX 후방 수요 축 재확인 트리거, 미 관세 결정 8월 대기·재고 재분배 지속이 프리미엄 유지. 아마존 AWS 2,200억달러·메타 1,050억달러 상향 CAPEX 서사와 결합해 이중 카운터, LME 재고 30.7만톤 감소 지속이 tightness 확인. 알루미늄 LME 3M 3,479달러/t·기니 보크사이트 수출 통제 잔존·중국 4,500만톤 생산 캡 강화가 수급 타이트, 철광석 161.91달러/t 사상 최고 유지·중국 부양책 신호가 카운터. 매크로 렌즈 - 실질금리 하락 시나리오가 산업금속 프리미엄 방어 축, 크로스에셋 렌즈 - 산업금속 상대 강세 지속."
      },
      {
        "time": "2026-08-09 07:15 KST",
        "type": "가격 회복",
        "sector": "크립토",
        "detail": "BTC·ETH·SOL·XRP. 크립토 위험선호 회복 지속 - 비트코인 65,000달러 돌파·이더리움 1,900달러대·솔라나 72.87달러·XRP 1.03달러 소폭 회복, NFP -23K 서프라이즈 이후 연준 9월 인하 오즈 65% 재확대가 위험자산 위험선호 재점화 트리거. Strategy(MSTR) 100달러 회복이 크립토 프록시 강세 축, spot BTC ETF 8월 net 유출 zero 유지·BlackRock IBIT 8/3 1.11억달러 매수·Fidelity 3,300만달러·Franklin 900만달러 매수 확인, spot ETH ETF 4주 연속 유입·7월 3.65억달러 net 유입 확정이 방어 축. CLARITY Act 상원 표결 9/14 재소집 이후 연기 잔존·spot SOL·XRP ETF 8월 심사 지연 리스크 잔존이 관망 축, 8/12 CPI·8/13 PPI 매크로 대기가 방향타. 정책 렌즈 - CLARITY 지연이 크립토 리레이팅 대기 국면 지속, 매크로 렌즈 - 연준 인하 경로 재확정이 위험선호 회복 카운터."
      }
    ]
  }
];
