const updates = [
  {
    ...
    "changes": [
      ...
      },
      {
        ...
        "type": "가격 약세",
        "sector": "에너지",
        "detail": "원유·천연가스. WTI 75달러대 약세 지속·브렌트 79달러대 조정 - 카타르 중재 하 이란·미국 호르무즈 부분 재개 서사 완결 국면 진입에 중동 지정학 프리미엄 소멸 유지, 전일 및 전전일 2세션 동안 10%+ 급락 여파 지속. OPEC+ 9월 188K bpd 증산 결정과 결합해 하방 압력 유지·EIA 원유·가솔린 재고 발표 대기·J.P. Morgan Global Research Q3 브렌트 평균 하향 조정 여지 유지, 천연가스 2.75달러 저점권·Freeport LNG 정비 8월 말·냉방 수요 시즌 프리미엄 대기. 매크로 렌즈 - 유가 약세 지속이 실질 인플레 완화·9월 연준 인하 오즈 확대 축, 크로스에셋 렌즈 - 에너지 섹터 상대 매력 약화가 성장주·기술주 로테이션 재점화 카운터로 다우 record close와 결합·나스닥 조정과 병존 국면."
      },
      {
        "time": "2026-08-06 15:00 KST",
        "type": "가격 강세",
