...
const data = [
  {
    ...
    tag: "인공지능·칩·데이터센터",
    stocks: [
      { tk:"SMH", nm:"VanEck Semiconductor", rs:"반도체 순수 노출 30종", aum:"28", er:"0.35%", ytd:"+22%", y1:"+45%" },
      { tk:"SOXX", nm:"iShares Semiconductor", rs:"반도체 30종·ICE 지수", aum:"16", er:"0.35%", ytd:"+20%", y1:"+42%" },
  ...
  },
  {
    ...
    tag: "비트코인·이더리움·디파이",
    stocks: [
      { tk:"IBIT", nm:"iShares Bitcoin Trust", rs:"비트코인 현물 최대", aum:"55", er:"0.25%", ytd:"+30%", y1:"+65%" },
      { tk:"FBTC", nm:"Fidelity Wise Origin BTC", rs:"비트코인 현물·피델리티", aum:"18", er:"0.25%", ytd:"+30%", y1:"+64%" },
      { tk:"ETHA", nm:"iShares Ethereum Trust", rs:"이더리움 현물", aum:"10", er:"0.25%", ytd:"+20%", y1:"+45%" },
      { tk:"BITO", nm:"ProShares Bitcoin Strategy", rs:"비트코인 선물 최초", aum:"3", er:"0.95%", ytd:"+28%", y1:"+58%" },
      { tk:"BLOK", nm:"Amplify Blockchain", rs:"블록체인 기업 테마", aum:"1.5", er:"0.71%", ytd:"+22%", y1:"+40%" },
    ]
  },
  {
    title: "🇺🇸 미국 대형주",
