...
const data = [
  ...
  },
  {
    ...
    tag: "방위산업·사이버보안",
    stocks: [
      { tk:"ITA", nm:"iShares US Aerospace", rs:"미국 방산·항공우주", aum:"17", er:"0.40%", ytd:"+15%", y1:"+28%" },
      { tk:"PPA", nm:"Invesco Aerospace", rs:"방산·항공우주 확장", aum:"6.5", er:"0.58%", ytd:"+14%", y1:"+26%" },
      { tk:"XAR", nm:"SPDR S&P Aerospace", rs:"S&P 방산·항공", aum:"1.9", er:"0.35%", ytd:"+13%", y1:"+24%" },
      ...
      { tk:"SHLD", nm:"Global X Defense Tech", rs:"AI·사이버·첨단 방산 기술·2026 최고 수익", aum:"8.7", er:"0.50%", ytd:"+80%", y1:"+58%" },
  ...
  },
  {
    ...
    tag: "태양광·풍력·리튬·수소",
    stocks: [
      { tk:"ICLN", nm:"iShares Global Clean", rs:"글로벌 클린에너지·반등 랠리", aum:"3", er:"0.40%", ytd:"+50%", y1:"+35%" },
      { tk:"TAN", nm:"Invesco Solar", rs:"태양광 순수 테마·정책 모멘텀", aum:"2", er:"0.67%", ytd:"+46%", y1:"+32%" },
  ...
  },
  {
    ...
    tag: "비트코인·이더리움·디파이",
    stocks: [
      { tk:"IBIT", nm:"iShares Bitcoin Trust", rs:"비트코인 현물 최대·AUM $58B·BTC 78.2만개 보유", aum:"58", er:"0.25%", ytd:"-16%", y1:"-18%" },
  ...
  },
  {
    ...
    stocks: [
      ...
      { tk:"EWY", nm:"iShares MSCI South Korea", rs:"한국 코스피 대형주·반도체·방산 주도 급등", aum:"16", er:"0.59%", ytd:"+49%", y1:"+173%" },
    ]
  },
];
