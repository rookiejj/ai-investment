// unicorn update archive — 사용자 모달 mentions용 (30일 보존)
...
const updatesArchive = [
  {
    ...
    "summary": "SpaceX S-1 정식 제출 5/15~22 윈도우 D-2~9 - Musk 트럼프 베이징 동행 5/13 출국 IPO 직전 외교 채널\n글로벌 유니콘 1,680개·합산 밸류 $8.6T - AI·ML 622개(37%)·$4.1T(47.6%) 카테고리 단일 우위\nTrue Anomaly $650M Series D - Eclipse·Riot 주도 우주 안보 카테고리 후기 단계 자본 흡수\nQ1 2026 시드·얼리 47개 동시 진입 - 'momentous year' 신규 코호트 사상 최대 페이스 잔존\n2H 2026 IPO 웨이브 카운트다운 - SpaceX 6월·Anthropic 10월·Databricks Q4·Stripe 2H 순차",
    "changes": [
      {
        "type": "정보 갱신",
        "sector": "우주·모빌리티·방산",
        "detail": "SpaceX(정식 S-1 제출 5/15~22 윈도우 D-2~9 카운트다운). Bloomberg 5/12 종합 - 4/1 SEC 비밀 제출 베이스에서 6/8 로드쇼 D-Day 위해 5/22 이전 S-1 공개 의무(SEC 15일 룰), 5/19~22 단일 윈도우로 좁힘. 목표 밸류 $1.75T 베이스에서 $2.0T+ 상향 보도, 조달 $75B로 美 IPO 사상 최대 라인업. Musk 5/13 트럼프 베이징 출국 동행 - Tim Cook(애플)·Larry Fink(블랙록)·Jensen Huang(NVDA) 메가캡 CEO 동행단으로 SpaceX·X·xAI 외교 라인 IPO 직전 직접 채널. 5/14~15 정상회담 의제 - 對中 AI 칩 수출 가이던스 + Taiwan + 이란·러시아 + 6차 협상 트랙. Starshield 위성·美 국방부 8사 AI 계약·Anthropic Colossus 1 단독 임대(300MW·NVIDIA 220K GPU)·Falcon 9·Starship·Starlink 4개 사업 라인 동시 가격 발견 구도. 美 4월 CPI 핫 데이터 + 시장 후퇴 환경에도 SpaceX IPO 스토리는 견조.",
        "time": "2026-05-13 19:30 KST"
      },
      {
        "type": "정보 갱신",
        "sector": "엔터프라이즈 SW",
        "detail": "글로벌 유니콘 1,680개·합산 밸류 $8.6T 베이스. Q1 2026 종합 - AI·ML 622개(37% 비중)·$4.1T(47.6% 비중)로 카테고리 단일 우위 - 사상 최대 집중도. PitchBook·Crunchbase 합산 글로벌 유니콘 딜 가치 $245.6B 사상 최고, 거래 227건·연환산 $1T 페이스. Databricks($134B 밸류·$5B 신규 라운드 협상) - 매출 런레이트 $5.4B 연환산·전년 +65% 성장·고객 20,000사 + S-1 비밀 제출 Q3 2026 윈도우·IPO 목표 $150~180B. Anthropic($300~900B 베이스) - 폴리마켓 IPO 먼저 확률 68% + $1.2T 토큰화 함의·5월 보드 $50B/$900B 라운드 결정 임박. Stripe($100B+) - 2025 텐더오퍼 $65B 베이스 +50%·IPO 2H 2026 윈도우 잔존. 2H 2026 단일 톱 IPO 시즌 - SpaceX 6월·Anthropic 10월·Databricks Q4·Stripe 2H 순차 라인업 카운트다운.",
        "time": "2026-05-13 19:30 KST"
      },
      {
        "type": "정보 갱신",
        "sector": "우주·모빌리티·방산",
        "detail": "True Anomaly($650M Series D, 4/28 클로징). Eclipse·Riot 주도 우주 안보 카테고리 후기 단계 자본 흡수 - 위성 추적·굤도 자율 시스템·국방부 우주군 협업 라인업. Q1 2026 단일 분기 우주·국방 카테고리에서 단일 최대 펀딩, SpaceX·Anduril·Vast·Relativity Space와 함께 우주·모빌리티·방산 카테고리 후기 자본 집중 가속. Parallel Web Systems(4/28 Series B $100M, Sequoia 주도, AI 검색 API 환각 최소화) + KreditBee(4/8 Series E $220M, $1.5B 밸류 인도 SMB 핀테크) 동시 베이스 - 'AI 인접 SW·우주 방산' 양 카테고리에 자본 집중되는 IPO 직전 양극화 구도 잔존. Boston Dynamics 美 나스닥 상장 6월 결정 임박 - SoftBank 9.5% 풋옵션 6월 만료, 추정 가치 30~40조원($21~28B) 단일 분기점 그대로.",
        "time": "2026-05-13 19:30 KST"
      }
    ]
  },
  ...
  },
  {
    ...
    "changes": [
      ...
      },
      {
        "type": "정보 갱신",
        "sector": "우주·모빌리티·방산",
        "detail": "SpaceX(증권신고서 정식 제출 5/15~5/22 윈도우·6/8 로드쇼·6/18~6/30 프라이싱 카운트다운). 5/5 정규장 시점에서 비밀 증권신고서 제출 베이스에서 정식 공개 제출까지 D-9~16 카운트다운 진입 - 6/8 로드쇼 시작·6/11 1,500명 리테일 투자자 투어·6/18~6/30 프라이싱 윈도우 일정 그대로. 목표 밸류 $1.75~2.0T·조달 $75B·영국·EU·호주·캐나다·일본·한국 리테일 30% 할당 베이스 잔존. ARK·Stableton 등 주요 분석 보고서 가격 정당화 모멘텀 누적. SpaceX-xAI 합병 베이스 + Cursor $60B 옵션 + Grok 코딩 팀 재건 + Colossus 2 슈퍼클러스터 1.5GW 가동 펀더멘털 라인업이 IPO 직전 단일 분기점.",
        "time": "2026-05-06 07:25 KST"
      },
      {
        "type": "정보 갱신",
    ...
    "changes": [
      {
        "type": "전략",
        "sector": "AI·ML",
        "detail": "Anthropic. 4/27 자사 블로그에 'Claude는 광고 없이 운영된다'는 입장을 공식화 - 광고 인센티브가 '진정으로 도움이 되는 AI 어시스턴트'와 양립할 수 없다는 논리를 IPO를 앞두고 명문화. 구독·B2B API·엔터프라이즈 시트만으로 매출을 확장하는 모델로 OpenAI(소비자 비중 큰 ChatGPT 광고 도입 가능성 보도 반복)와의 차별화 포지션 강화. 4/24 Alphabet $40B + 4/20 Amazon $25B + NEC 30,000명 + 세컨더리 $1T + ARR $300억 돌파에 이어 'IPO 내러티브의 핵심 자산'으로 신뢰성·프라이버시를 추가, 10월 IPO $400~500B 타겟의 펀더멘털 보강.",
        "time": "2026-04-28 13:00 KST"
      },
      {
        "type": "마일스톤",
        "sector": "우주·모빌리티·방산",
        "detail": "SpaceX. 4/22~23 Starbase 1일차 125명 애널리스트·Tennessee 2일차 21개 주관사 투어 완료 후 6월 로드쇼 프라이싱 페이스 진입 확정. 타겟 밸류 $1.75T·조달 규모 $75B로 사상 최대 IPO 기록(2019 사우디 아람코 $29B의 약 2.6배)을 노린다. Starlink 가입자 9백만 명 돌파·2026 매출 $160억 가까이 도달이 펀더멘털을 받친다. 같은 6개월 윈도우 내 OpenAI($1T 타겟·Q4) + Anthropic($400~500B·10월) IPO와 합산 $240B+ 자본 조달이 단일 IPO 사이클에 집중되며 시장 흡수 부담이 가시화 - Bitcoin·소형주 유동성 흡수 우려 동반.",
        "time": "2026-04-28 13:00 KST"
      }
    ]
  },
