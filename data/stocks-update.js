...
const updates = [
  {
    ...
    summary: `메가캡 4사 Q1 일제 비트 — GOOGL Cloud +63%·MSFT Azure +38%·AMZN AWS +28%·META 매출 +33%
GOOGL EPS $5.11 vs 컨센 $2.62 압도·Cloud 백로그 $460B QoQ 두 배·CapEx $180~190B 상향
META CapEx $125~145B 상향($115~135B에서)·DAP 미스로 AH -6% 후퇴
...
Brent $118.03 +6%·WTI $106.88 +7% 갱신 — 트럼프 봉쇄 무기한 유지 발언`,
    changes: [
      { type: "실적 발표", sector: "AI 플랫폼",
        detail: "Microsoft(MSFT)·Alphabet(GOOGL)·Meta(META)·Amazon(AMZN). 4/29 美장후(한국시간 4/30 새벽) 메가캡 4사가 약 80초 윈도우 안에 동시 발표하며 일제히 비트. ①Microsoft Q1 FY26 매출 $77.7B +18%·EPS $4.13 비트·Azure $21.5B +38% CC, Hood CFO가 '용량 한계로 +40%까지 잠재'라고 명시. OpenAI 지분손실 -$0.41 EPS로 GAAP $3.72(+13%)로 둔화하나 Microsoft 자체 펀더멘털은 견조. FY26 CapEx 증가율 FY25 초과 가이던스. ②Alphabet Q1 매출 $109.9B +22% 컨센 $107.1B 비트, EPS $5.11 컨센 $2.62 압도. Google Cloud $20.03B +63% 컨센 $18.4B 비트, 백로그 $460B QoQ 두 배. Pichai 컨콜 '단기 컴퓨트 제약' 직접 명시. CapEx $180~190B로 상향($175~185B에서). Gemini Enterprise 유료 MAU QoQ +40%, 자사 모델 분당 160억 토큰 +60% QoQ. ③Meta Q1 매출 $56.31B +33% 컨센 $55.45B 비트, EPS $10.44(세제혜택 $8B 포함, 조정 $7.31), 영업이익률 41%. CapEx $125~145B로 상향($115~135B에서) → AH -6%. DAP 3.56B 컨센 3.62B 미스, Q2 가이던스 $58~61B. ④Amazon Q1 매출 $181.5B +17%, AWS $37.59B +28% 3년 만 최고 성장률 컨센 +26% 비트, AWS 영업익 $14.2B 사상 최대, EPS $2.78. Q2 가이던스 $194~199B(+16~19%). 4사 합산 AI 인프라 수요·CapEx 가속이 4/28 OpenAI 매출 미스發 매도세를 부분 상쇄.",
...
4/28 美 마감 S&P 7,138.80 -0.49%·나스닥 24,663.80 -0.9% OpenAI 매출 미스 후폭풍
Brent $113.47 8거래일 갭업 2022.6 이후 최고·WTI $99 호르무즈 봉쇄 두 달째
Visa Q2 EPS $3.31 비트·신규 $20B 자사주·시간외 +5.2%
SBUX Q2 EPS $0.50 비트·동일점포 +6.2%·FY26 가이던스 5% 상향
4/29 美장후 MSFT·GOOGL·META·AMZN 80초 윈도우 동시 발표 + 4/30 FOMC 동결`,
    changes: [
      ...
      { type: "실적 발표", sector: "핀테크·결제",
        detail: "Visa(V). 4/28 장후 Q2 FY26 결과 — 매출 $11.23B 컨센 $10.96B 상회(+17% YoY), 조정 EPS $3.31 컨센 $3.09 비트, 순이익 $6.0B(+32% YoY), 결제량 +9%·크로스보더 +12%·처리 거래 +9%로 소비·여행 모두 견조. 이사회 신규 $20B 클래스A 자사주 매입 프로그램 승인 + 분기 배당 주당 $0.670 유지. 2022년 이후 가장 강한 매출 성장률을 입증하며 결제망 듀오폴리(V·MA) 가격결정력 + 글로벌 소비 회복력 동시 점검. 시간외 +5.2% 강세, 결제·핀테크 카테고리 톤 반등.",
        time: "2026-04-29 19:00 KST" },
      { type: "실적 발표", sector: "소비·리테일",
        detail: "Starbucks(SBUX). 4/28 장후 Q2 FY26 결과 확정 — 조정 EPS $0.50 컨센 $0.42 비트, 글로벌 동일점포 +6.2% 컨센 +4.0% 큰 폭 상회. 미국 동일점포 +7.1%(트래픽 +4.3%)로 2분기 연속 트래픽 양전환을 확정해 Niccol CEO 턴어라운드 1년차 핵심 점검대 통과. FY26 가이던스를 글로벌·미국 동일점포 +5%로 상향(기존 +3%), 조정 EPS 가이던스도 $2.25~2.45로 상향(기존 $2.15~2.40). 2년 만에 첫 EPS 성장 분기. 시간외 강세, QSR 카테고리 다시 긍정 톤. Booking Holdings는 같은 날 Q1 매출 $5.53B +16% 컨센 부합·조정 EPS $1.14 비트로 큰 무리 없이 통과했으나 중동 분쟁 영향으로 Q2 룸나잇 +2~4% 가이던스 둔화 톤이 동반.",
        time: "2026-04-29 19:00 KST" },
      { type: "정보 갱신", sector: "에너지",
      ...
      { type: "실적 발표", sector: "금융·은행",
        detail: "Robinhood(HOOD)·Booking(BKNG). 4/28 장후 Robinhood Q1 EPS $0.38 컨센 $0.43 미스·매출 $1.07B 컨센 $1.18B 미스로 트레이딩 환경 변화 + 옵션·크립토 거래량 둔화가 직격, 시간외 약세. Booking은 Q1 매출 $5.53B +16% 컨센 부합·조정 EPS $1.14 +5.7% 비트, 룸나잇 338M +6%(중동 분쟁 제외 시 +8%) 견조하나 Q2 룸나잇 가이던스 +2~4%로 둔화 톤 — 회사는 중동 영향이 6월 말까지 지속 후 2H 회복 가정을 명시. 자사주 매입은 $3.6B + 배당 $0.3B로 Q1 사상 최대 환원.",
        time: "2026-04-29 19:00 KST" },
    ]
  },
  {
...
Visa Q2 매출 $11.23B EPS $3.31 동시 비트·신규 $20B 자사주 매입
Starbucks Q2 EPS $0.50 비트·미국 동일점포 +7.1%·FY26 가이던스 상향
Brent $110·WTI $98 7거래일 연속 갭업·BTC $76K -3% 위험자산 동반 약세`,
  ...
  },
  {
    ...
    summary: `GM Q1 매출 $44.02B EPS $2.78 동시 비트, 풀해 가이던스 신뢰 철회
...
4/29 GOOGL·MSFT·META·AMZN 동시 발표 + 4/30 FOMC 직전 관망`,
    changes: [
      { type: "실적 발표", sector: "자동차·모빌리티",
        detail: "General Motors(GM). 4/28 장전 Q1 2026 결과 공개 — 매출 $44.02B 컨센 $43.03B 비트(+2.3% YoY)·조정 EPS $2.78 컨센 $2.72 비트로 외형 양면 모두 어닝 비트. 그러나 GM은 트럼프 행정부와의 자동차 관세 협상이 진행 중이라는 점을 들어 풀해 2026 가이던스(EPS $11~13·조정 EBIT $13~15B·순이익 $10.3~11.7B)에 대해 'CFO Paul Jacobson — 투자자가 더 이상 신뢰해선 안 된다'고 공식 표명. 동시에 자사주 매입 프로그램을 일시 중단하면서도 2월 발표한 $2B 가속 자사주 매입(ASR)은 Q2 안에 마무리할 계획. Q1 관세 영향만 $750M~$1B 추정, 풀해 영향은 $3~4B로 가이던스. 컨콜은 협상 중이라는 이유로 4/30 목요일로 연기. 시장은 비트 자체보다 가이던스 신뢰 철회와 자사주 일시 중단을 중심으로 해석, 한 분기 동안의 관세 협상 결과가 자동차 섹터 단기 멀티플의 핵심 변수로 부상.", time: "2026-04-28 19:10 KST" },
      { type: "정보 갱신", sector: "에너지",
...
4/29 GOOGL·MSFT·META·AMZN 동시 + 4/30 FOMC 슈퍼위크 본격`,
  ...
  },
  {
    ...
    changes: [
      ...
      { type: "정보 갱신", sector: "시장",
        detail: "美 증시 4/27 마감. S&P 500 7,173.91 +0.12%·나스닥 24,887.10 +0.20% 양 지수 동반 사상 최고 마감, 다우는 -62.92p(-0.13%) 49,167.79로 후퇴. 시장은 4/29 장후 GOOGL·MSFT·META·AMZN 메가캡 4사 동시 실적·4/30 FOMC(동결 100% priced in)·5/1 AAPL·5/2 PCE를 앞두고 상승 폭을 제한. 이번 주 200+ S&P 종목 보고. 첫 점검대였던 VZ는 Q1 매출 $34.4B +2.9%·조정 EPS $1.28 +7.6% 컨센 비트, 13년만에 1Q 포스트페이드 폰 순증 양전환에 풀해 EPS 가이던스를 +5~6%로 상향, 주가 +3.5%로 통신 섹터 톤을 긍정적으로 만들었다. DPZ는 컨센 미스로 -10.5% 급락하며 소비재 우려 부각.", time: "2026-04-28 07:24 KST" },
      { type: "정보 갱신", sector: "양자·크립토",
