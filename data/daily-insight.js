const DAILY_INSIGHTS = [
  {
    date: "2026-08-12",
    title: "왜 CPI 하루 앞두고 방산·조선주가 가장 크게 조정받았나",
    body: `어제 한국 증시에서 반도체는 삼성전자 +4.13%·SK하이닉스 +0.4% 강세로 마감한 반면, 방산은 한국항공우주 -12.1%·LIG넥스원 -7.7%·현대로템 -5.9%·한화에어로 -4.7% 일제 급락했습니다. 조선(한화오션 -5.7%·HD현대중공업 -5.5%)과 2차전지(삼성SDI -4.6%·에코프로비엠 -4.4%)도 같은 방향으로 무너졌습니다. 미 CPI 발표를 하루 앞두고 왜 방산·조선·배터리가 유독 크게 조정받았을까요.

핵심은 '실질금리 하락 시나리오와 사이클 프리미엄의 반비례 관계'입니다. CPI 컨센이 3.4% YoY인데 시장은 미달을 기대하고 있고, 미달 시 연준 9월 인하 오즈가 82%에서 90%대로 확장됩니다. 그러면 실질금리는 더 하락하고, 이는 성장주(반도체·바이오)에는 DCF 할인율 축소로 즉시 프리미엄 확장입니다. 반면 방산·조선·배터리처럼 '인플레이션 사이클 후반부' 프리미엄이 큰 섹터는 반대로 축소됩니다. 인플레이션이 완화된다는 시그널은 사이클 후반부의 '가격 결정력'이 사라진다는 의미이기 때문입니다.

역사적으로 이 패턴은 2019년 7월과 2024년 10월이 대표적입니다. 2019년 7월 파월 연준이 첫 인하를 단행한 주간, 방산주(LMT·RTX·NOC)는 매출 사상 최고에도 -8%~-12% 조정을 받았고, 반대로 성장주(FANG)는 +5% 이상 랠리했습니다. 2024년 10월 CPI 미달 발표 당일에도 조선주(HD현대중공업·한화오션)가 하루 -6% 낙폭을 기록한 반면 SK하이닉스는 +4% 상승했습니다. 사이클 후반부 프리미엄을 받은 종목은 '인플레 완화 시그널'에 가장 크게 반응합니다.

한국 투자자에게 이 원리의 의미는 두 가지입니다. 첫째, 오늘 밤 미 CPI가 컨센 3.4% 미달로 나오면 방산·조선·배터리 조정은 확대될 수 있고, 성장 프리미엄 섹터(반도체·바이오)는 추가 상승 카운터가 발동됩니다. 둘째, 반대로 CPI가 상회하면 지난 8/11의 방산 -12.1% 조정은 과잉 반응이었던 것으로 판명돼 반등 카운터가 발동됩니다. 즉 오늘 밤의 CPI가 사이클 후반부 프리미엄의 방향을 결정하는 분수령이라는 점을 기억해야 합니다.`,
    assets: ["한국항공우주", "방산", "실질금리", "CPI"],
  },
  {
    date: "2026-08-11",
