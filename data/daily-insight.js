const DAILY_INSIGHTS = [
  {
    ...
    body: `이번 주 목요일부터 토요일(현지 8/27~29)까지 잭슨홀 심포지엄이 열립니다. 파월이 물러난 후 신임 워시 의장이 8/28 첫 기조연설을 하는 자리라 미국 10년물 국채 옵션 내재변동성이 이미 급등했고, 캐나다 CIBC·JPM 이코노미스트들이 "이번 3일간의 톤이 향후 6개월 미국 금리 궤적을 결정한다"는 리포트를 잇달아 내놓고 있습니다. 왜 학술 컨퍼런스 하나가 그렇게 오래 시장을 지배할까요.
...
한국 투자자에게 두 가지 결정적 시사점이 있습니다. 첫째, KST 8/28 밤 워시 연설 다음 개장(금요일)에 원달러 환율과 국내 은행·리츠 주가 gap이 대폭 확대될 수 있습니다 - 매파 톤이면 원달러 1,410원 재돌파, 비둘기 톤이면 1,380원 재이탈이 실현 가능한 밴드입니다. 특히 이번엔 신임 의장의 첫 톤이라 "예상 밖" 리스크가 크니 금요일 아침 급격한 방향 이탈에 대비해야 합니다. 둘째, 워시가 매파 시그널을 던지면 한국은행 이창용 총재도 8/27 금통위에서 동결 → 매파 톤으로 균형을 맞출 가능성이 높습니다 - 즉 이번 주 목·금 이틀간 한미 금리차가 40bp 밴드에서 급변할 리스크가 있으니 외국인 수급이 몰린 은행·화학·건설 등 금리 민감 섹터의 회전이 클 수 있습니다.`,
